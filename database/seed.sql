...
-- Generated at 2026-06-16T09:56:57.974Z.
...
on conflict (id) do update set
  ...
  updated_at = now();
insert into sources (id, name, url, type, priority, collection, include_url, exclude_url, notes, updated_at)
values ('radio-communautaire-veille', 'Radios et annonces communautaires', 'https://jobfaso.com/contacts.html', 'community_channel', 1, 'manual_only', array['emploi', 'artisan', 'chantier', 'journalier', 'service', 'apprentissage']::text[], '{}', 'Canal inclusif pour offres entendues a la radio ou dans les quartiers. Soumission via formulaire/WhatsApp puis verification admin.', now())
on conflict (id) do update set
  name = excluded.name,
  url = excluded.url,
  type = excluded.type,
  ...
  updated_at = now();
insert into sources (id, name, url, type, priority, collection, include_url, exclude_url, notes, updated_at)
values ('marches-artisans-submissions', 'Marches, ateliers et artisans', 'https://jobfaso.com/contacts.html', 'informal_market', 1, 'manual_only', array['macon', 'soudeur', 'menuisier', 'plombier', 'electricien', 'tailleur', 'chauffeur', 'apprenti']::text[], '{}', 'Collecte via relais terrain, syndicats, ateliers, maitres artisans et formulaires simples. Publication uniquement apres verification.', now())
on conflict (id) do update set
  name = excluded.name,
  url = excluded.url,
  type = excluded.type,
  ...
  updated_at = now();
insert into sources (id, name, url, type, priority, collection, include_url, exclude_url, notes, updated_at)
values ('mairies-communes-veille', 'Mairies et communes', 'https://jobfaso.com/contacts.html', 'local_government', 2, 'manual_only', array['recrutement', 'communique', 'chantier', 'formation', 'appel']::text[], '{}', 'Veille locale pour chantiers communaux, agents temporaires, appels a candidatures et travaux de proximite.', now())
on conflict (id) do update set
  name = excluded.name,
  url = excluded.url,
  type = excluded.type,
  ...
  updated_at = now();
insert into sources (id, name, url, type, priority, collection, include_url, exclude_url, notes, updated_at)
values ('centres-formation-apprentissage', 'Centres de formation et apprentissage', 'https://jobfaso.com/contacts.html', 'training', 2, 'manual_only', array['apprentissage', 'formation', 'stage', 'atelier', 'metier']::text[], '{}', 'Canal pour stages, apprentissage metier, alternance, formations courtes et insertion professionnelle.', now())
on conflict (id) do update set
  name = excluded.name,
  url = excluded.url,
  type = excluded.type,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('aca4c3653df020e64c88f764b32fce4deb50f0fafb7c2879670cd13d18cc1c80', 'bfemploi', 'BFemploi', 'https://www.bfemploi.com/', 'BFemploi.com', 'BFemploi', 'Burkina Faso', null, null, null, false, 'https://www.bfemploi.com/examens-concours', 'A classer', 'needs_review', 'BFemploi.com - Liste des pages - Infos Connexion Login Candidat: Login Employeur/Recruteur: Inscription Espace Candidats Les annonces Connexion Inscription Demande d''emploi Recherche Examens et concours Espace Employeurs Connexion Inscription Publier une annonce Recherche CV Mot de passe Les demandes Ressources Telechargements Liens utiles Infos - Guides Examens-Concours Newsletter Repertoires Ecoles de formation Entreprises Appels d''offre Contact Nous contacter Nous recommander Aide - FAQ Newsletter ☰ Les annonces Espace Candidats Espace Employeurs Publier une annonce Recherche Newsletter Les demandes Ressources Nous contacter Espace Candidats Les annonces Connexion Inscription Demande d''emploi Recherche Examens et concours Espace Employeurs Connexion Inscription Publier une annonce Recherche CV Mot de passe Les demandes Ressources Telechargements Liens utiles Infos - Guides Examens-Con', 'https://www.bfemploi.com/examens-concours', '2026-06-16T09:27:59.177Z', 0, 0, '2026-06-16T09:27:57.139Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('430c3e9488347993650f6ab367506e280ef6ca97c2baab177df4a8e55169fadd', 'bfemploi', 'BFemploi', 'https://www.bfemploi.com/', 'Responsable Administration de Projet', 'BFemploi', 'Burkina Faso', '2026-06-25', '2026-06-15', '2026-06-25', false, 'https://www.bfemploi.com/annonce-details-3878.html', 'A classer', 'needs_review', 'Responsable Administration de Projet - BFemploi.com Connexion Login Candidat: Login Employeur/Recruteur: Inscription Espace Candidats Les annonces Connexion Inscription Demande d''emploi Recherche Examens et concours Espace Employeurs Connexion Inscription Publier une annonce Recherche CV Mot de passe Les demandes Ressources Telechargements Liens utiles Infos - Guides Examens-Concours Newsletter Repertoires Ecoles de formation Entreprises Appels d''offre Contact Nous contacter Nous recommander Aide - FAQ Newsletter ☰ Les annonces Espace Candidats Espace Employeurs Publier une annonce Recherche Newsletter Les demandes Ressources Nous contacter Espace Candidats Les annonces Connexion Inscription Demande d''emploi Recherche Examens et concours Espace Employeurs Connexion Inscription Publier une annonce Recherche CV Mot de passe Les demandes Ressources Telechargements Liens utiles Infos - Guide', 'https://www.bfemploi.com/annonce-details-3878.html', '2026-06-16T09:28:00.003Z', 0, 0, '2026-06-16T09:27:57.140Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('d0420a8bbaef2622b3b8f6f28e9df21e43d291c400463e0c849b802233ba86e5', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'BTP, construction', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso?f%5B0%5D=im_field_offre_secteur%3A26', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso?f%5B0%5D=im_field_offre_secteur%3A26', now(), 0, 0, '2026-06-16T09:28:08.032Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c4b9faa691c7944eaa719afdc9a0dfcc408770387f77b3359e18638b1ee53fd1', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Distribution, vente, commerce de gros', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso?f%5B0%5D=im_field_offre_secteur%3A117', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso?f%5B0%5D=im_field_offre_secteur%3A117', now(), 0, 0, '2026-06-16T09:28:08.032Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c80ddd55eadc78df8e3c8b1df53e1e9e060e936c3ca03ba41d3bb9f24888017f', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Tous les secteurs d''activité', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso', now(), 0, 0, '2026-06-16T09:28:08.032Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('0f8cf7e9b6c7f7c7d4d6fbd7e5e24fb701770634cb962b8cba0f7601ae25c918', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Toutes les régions', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso', now(), 0, 0, '2026-06-16T09:28:08.032Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7d433d18d7103fb188e21a11f668c33673d04aefe11eec7c9f87d529363abf6a', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Toutes les offres d´emploi', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso', now(), 0, 0, '2026-06-16T09:28:08.033Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('fe2b148138f77d8260ff59e653965606d78c6e30e5abbf15b45e7f2e22dfee06', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Qui sommes-nous ?', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/qui-sommes-nous', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/qui-sommes-nous', now(), 0, 0, '2026-06-16T09:28:08.033Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('fb31aea5641f7b4206fc30bd0f6377895daebaa7f02138bf88b15ed6c2b643d4', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Plan du site', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/plan-site', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/plan-site', now(), 0, 0, '2026-06-16T09:28:08.033Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('a6148d1f633c866e32f86493c5ae7ef1099d3517e4ef21837a774fc8f876fca5', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Achats Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A1127', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A1127', now(), 0, 0, '2026-06-16T09:28:08.033Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('9cb4a6e41a10c742d21e6076caa209f18e4ddd349c1253bdb7961825c2d484ab', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Commercial, vente Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A29', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A29', now(), 0, 0, '2026-06-16T09:28:08.033Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('359c3adc9fdccb2f58552da79a7f65e56c771ed9609772ebfd6e4efe925844eb', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Gestion, comptabilité, finance Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A30', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A30', now(), 0, 0, '2026-06-16T09:28:08.033Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1d4f9fc71e0b8f0cb623c074c855b0483bfdc04e81ba0554dd4bda0cf295b8a4', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Informatique, nouvelles technologies Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A31', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A31', now(), 0, 0, '2026-06-16T09:28:08.033Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('aa1bee8d42bef13890cf9d153be72aa031a7c27d471dc05a95ae0252d23926b0', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Juridique Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A1115', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A1115', now(), 0, 0, '2026-06-16T09:28:08.033Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('634e1ddb3ea86a1d131c0522fdb31f85b0d0c90fc6997ad27dabb466d9f262fe', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Management, direction générale Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A32', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A32', now(), 0, 0, '2026-06-16T09:28:08.033Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('6e00c135a458dfe06f2db5973b3cd4b816f4bf6e631b15717ad5aa2d6b23d659', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Marketing, communication Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A33', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A33', now(), 0, 0, '2026-06-16T09:28:08.033Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('871c5797c16bc0ac8a467e3f803866605ea308a52b53cef20886c9e8356d6a2f', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Métiers de la santé et du social Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A34', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A34', now(), 0, 0, '2026-06-16T09:28:08.034Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('60e9e1d2a3de05dd934d8d74dfb78a014414f373516c299794b13f455f0dd8bc', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Métiers des services Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A35', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A35', now(), 0, 0, '2026-06-16T09:28:08.034Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7534521dde6336d819dfa1fc08fbc8139c16b288e6cab8f8b21ccbd44ef6e7d0', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Métiers du BTP Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A36', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A36', now(), 0, 0, '2026-06-16T09:28:08.034Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('8f6825eb59f5de18cc0ed6fa2ddddfc05bfa3450920d490be049a671f797afea', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Production, maintenance, qualité Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A37', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A37', now(), 0, 0, '2026-06-16T09:28:08.034Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('5a3f2891c05efeb70309c238967bf647e2210f2dfbbf786420be25c416799a9f', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'R&D, gestion de projets Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A39', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A39', now(), 0, 0, '2026-06-16T09:28:08.034Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('bade8806cea03af221a439ec86bea2c518fd190d0a846560831092a20d563e8d', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Secrétariat, assistanat Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A40', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A40', now(), 0, 0, '2026-06-16T09:28:08.034Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('8d34e7590459d34d1545b3986d7a64a7825fe4354bac7892ca05865acc328988', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Télémarketing, téléassistance Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A525', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A525', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('2084593a4d55b4a9fa9dc95b90aaeebeb360439a62cc44999caba92537168fd7', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Tourisme, hôtellerie, restauration Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A41', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A41', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('d6c7850ce3af5142612a42f753d9b5f4bbcbe4aea3ec05edd8b584a3756d2a5a', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Transport, logistique Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A28', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso/?f[0]=im_field_offre_metiers%3A28', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('234d3df03926e110efee4f796ddc5d3d6ebbf7bd9f22d84d2c4d8c326c77b68c', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Ingénieurs', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/emplois-actifs/ingenieurs', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/emplois-actifs/ingenieurs', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('ea082bf4cd1006738689f92973bb8a3889ffba4e4e3a721713a30008a7bc2c00', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emplois actifs', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/emplois-actifs', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/emplois-actifs', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c206193d3b0bbe21f7248a2e64dbbae1179c696c5b041de23d7f0b7dad7ed145', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Ingénieurs', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recrutements-permanents/ingenieurs', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recrutements-permanents/ingenieurs', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('2999d8c01d620d99550f50c5cb932b6fddcc169095f2c7be39f81369a96d610d', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Recrutements permanents', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recrutements-permanents', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recrutements-permanents', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c232c5a7b77ac7f8b38bd62f5c7d4ae9d8b3ed11c4dfa2cdbd67463df581fb8d', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Maroc', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploi.ma/', 'A classer', 'needs_review', null, 'https://www.emploi.ma/', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('e01b6d95403fb0baa1e742e2d0064be5fd5516d761a4913dae2f0b4279b3152d', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Côte d’Ivoire', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploi.ci/', 'A classer', 'needs_review', null, 'https://www.emploi.ci/', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('def39cf101ad8eb9f972a5a738419c39d96a3495d8033d9129558ade98cf1b05', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Congo', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploi.cg/', 'A classer', 'needs_review', null, 'https://www.emploi.cg/', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('71f746e1c8958e589a5e56d37466646c69095f0b7e87a7e408921a706fe1a9de', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Cameroun', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploi.cm/', 'A classer', 'needs_review', null, 'https://www.emploi.cm/', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('095f5cf1a656012f19e6f61e56bf58e20ce974fb241c1ddf760b876ce357037d', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Sénégal', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploisenegal.com/', 'A classer', 'needs_review', null, 'https://www.emploisenegal.com/', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('4e19b80358354197d729caeca3148520990cdbe3f37ae9eafc437053a5736d44', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Burkina Faso', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/', now(), 0, 0, '2026-06-16T09:28:08.035Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('0063f82b586801f66a9213033a19f3be972b01974f5d875917bbec6b035dfca0', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Guinée', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiguinee.com/', 'A classer', 'needs_review', null, 'https://www.emploiguinee.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('6218771d455ca3ee68df23bff407d0f69a1a67db85166b2a3aecc8d221161238', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Togo', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploi.tg/', 'A classer', 'needs_review', null, 'https://www.emploi.tg/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('70cb0d16b85094d0fea05512d4aaca4035d316aeb2662940e16d8c75286763fd', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Gabon', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploi.ga/', 'A classer', 'needs_review', null, 'https://www.emploi.ga/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('a690540c614f6ba7146721715e833048adaf9a1da645ea2c42a6d2aec064fcdb', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Mauritanie', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploimauritanie.com/', 'A classer', 'needs_review', null, 'https://www.emploimauritanie.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('9d9cdd4192106a5ba2389a482c32497e420a57c6ab14a536e9fd9a1e872fc24c', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Bénin', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploibenin.com/', 'A classer', 'needs_review', null, 'https://www.emploibenin.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1d92e7bf0bacc9b8ed7b74349c1f760365558a3476f79a9a9efc990e8cbbd7ff', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Mali', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploimali.com/', 'A classer', 'needs_review', null, 'https://www.emploimali.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('e120ec35b514b0baf425176472b7d3f156c1b0b54468392f32840888ddd6ad94', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Congo RDC', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploi.cd/', 'A classer', 'needs_review', null, 'https://www.emploi.cd/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7b31d59f897e374b34890e8f8ceb171a523c57144ee1d6155732dafa5fcedfc2', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Algérie', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.algeriejob.com/', 'A classer', 'needs_review', null, 'https://www.algeriejob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('10d60900e28075b6cb304488c372392e828fcfbb4b8d272019def046372fc523', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Niger', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.nigerjob.net/', 'A classer', 'needs_review', null, 'https://www.nigerjob.net/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1623526900bf377c95fffd9dd1f133143a8bac6282e5fc6dbf66d5c2d7765da7', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Tchad', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploi.td/', 'A classer', 'needs_review', null, 'https://www.emploi.td/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7e78216c20b625819e745686893bfd669a04196f6ae279f0614688ce69af57b6', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Burundi', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploi.bi/', 'A classer', 'needs_review', null, 'https://www.emploi.bi/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('f6864d2693995c1576df2d2a07c45dad046cb336d7441c5ecbd1fcbd6003123e', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Ghana', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.ghanajob.com/', 'A classer', 'needs_review', null, 'https://www.ghanajob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c74711399d85c41568e1280308d2fb000148176831fd569bc2e96ae4dcf76639', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Nigeria', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.nigeriajob.com/', 'A classer', 'needs_review', null, 'https://www.nigeriajob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('f8be71c45636291279405cf57e30a85d6216ddb4c1c37791123b45350cd41005', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Kenya', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.kenyajob.com/', 'A classer', 'needs_review', null, 'https://www.kenyajob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7ca0b3b220078eeda86eb0b74e46bab6a10bdc9d0798b915e159d973501db5ef', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Ouganda', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.ugandajob.com/', 'A classer', 'needs_review', null, 'https://www.ugandajob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('30453f4fbaa2d2b7a85103081b341abd8178f20def42545a73ab7ceb0e167a51', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Rwanda', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.rwandajob.com/', 'A classer', 'needs_review', null, 'https://www.rwandajob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('a5d0c9cdd55fc62812c5cf2fbddf39fd0770b9f9aa60be8656ccbcd448ad50ad', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Tanzanie', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.tanzajob.com/', 'A classer', 'needs_review', null, 'https://www.tanzajob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c98ecd5ded490eff2c04886180588217adb996dd98ec66cbdb1a08922661e2e3', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Botswana', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.botswajob.com/', 'A classer', 'needs_review', null, 'https://www.botswajob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('b088c0adaa209b4d5266bf497a2c9bd50e838022c4db67927e7b9990f38e3686', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Malawi', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.malawijob.com/', 'A classer', 'needs_review', null, 'https://www.malawijob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('4b00d395bf5e6c452f11ba5e15b1c41c66fbc97a6570a431fa172c9019e863e4', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Namibie', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.namijob.com/', 'A classer', 'needs_review', null, 'https://www.namijob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('739e3e1d6fd86d9ea7aa0e5efb373d00fd1ce626c2dcf65d59c86d6aebb85c90', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Zambie', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.zambiajob.com/', 'A classer', 'needs_review', null, 'https://www.zambiajob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('834c3f5226266842c092ada46c0e0f7e786bdea4db26da5942de4070ab315ca0', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Zimbabwe', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.zimbajob.com/', 'A classer', 'needs_review', null, 'https://www.zimbajob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('f660c9ce71ee45e8bf617334cec53b4ccf4bbfa8bff7cab5f621bcb34d167413', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Sierra Leone', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.sierraleonejob.com/', 'A classer', 'needs_review', null, 'https://www.sierraleonejob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1492447d76e90aa9075e6e56d2ded993e7acf31d0a8db490c54f1b24eed40d1a', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Afrique du Sud', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.zajob.com/', 'A classer', 'needs_review', null, 'https://www.zajob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7d00300f29858c8188798ecf763b29d9bc38c029cf238ffcaec852836c180607', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Soudan du Sud', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.southsudanjob.com/', 'A classer', 'needs_review', null, 'https://www.southsudanjob.com/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('2cda0bc49f3549a025932ca713163c9096334099a7da3576934f47711cb777be', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Emploi Centrafrique', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploi.cf/', 'A classer', 'needs_review', null, 'https://www.emploi.cf/', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('5fbf3fc41b08fa029c4a4853ed9bddc18231580fdec8c2d424a1e59210a43d4d', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Mentions légales', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/mentions-legales', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/mentions-legales', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('659b22d65aa34a5ec1df9b81a6f9912775bcb230412ff7e5aad1b4495a7c3f52', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Propriété Intellectuelle', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/propriete-intellectuelle', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/propriete-intellectuelle', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('d1453f891616480538c060abf7fc0b7efad29c925b19af7e7fde6df7259fab8c', 'emploiburkina', 'Emploiburkina', 'https://www.emploiburkina.com/', 'Recherche', 'Emploiburkina', 'Burkina Faso', null, null, null, false, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso', 'A classer', 'needs_review', null, 'https://www.emploiburkina.com/recherche-jobs-burkina-faso', now(), 0, 0, '2026-06-16T09:28:08.036Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('8ff6ce7fd04032bddb70f76dfe068eb4c001fdd38460f17ed9f1e4ffeda97b4c', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Administration', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/administration/', 'A classer', 'needs_review', 'Archives des Administration - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat Créer un compte Créer u', 'https://www.travail-burkina.com/category/offres-emploi/administration/', '2026-06-16T09:28:47.009Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('2cec55b044d44f5082901b560bd7c72d354b0802258ee00a3a3c0bb6b66fd726', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Agriculture – Agro-alimentaire', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/agriculture-agro-alimentaire/', 'A classer', 'needs_review', 'Archives des Agriculture – Agro-alimentaire - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat Créer u', 'https://www.travail-burkina.com/category/offres-emploi/agriculture-agro-alimentaire/', '2026-06-16T09:28:47.918Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c2712d4612083df4d3f04a591ef17ecff3cb86a09c7b791b2f42c0005338d4b9', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Architecture', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/architecture/', 'A classer', 'needs_review', 'Archives des Architecture - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat Créer un compte Créer un ', 'https://www.travail-burkina.com/category/offres-emploi/architecture/', '2026-06-16T09:28:48.784Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('f20e69aa364282b4bc7305236f00eada7c6429d9b1bb8811206b2f743563a36a', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Assistance – Secrétariat', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/assistance-secretariat/', 'A classer', 'needs_review', 'Archives des Assistance – Secrétariat - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat Créer un comp', 'https://www.travail-burkina.com/category/offres-emploi/assistance-secretariat/', '2026-06-16T09:28:49.860Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('d31bfa13faba5196c4d1d9433bcd8af4fe38f02e97bd801cecbc47fed03061d3', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Biologie – Chimie', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/biologie-chimie/', 'A classer', 'needs_review', 'Archives des Biologie – Chimie - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat Créer un compte Crée', 'https://www.travail-burkina.com/category/offres-emploi/biologie-chimie/', '2026-06-16T09:28:51.721Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('0135cb95bb2ef40b893ab6c3532c14fedd8a868ec8d46141a40dc7e703c812b6', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Commerce – Marketing – Vente', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/commerce-marketing-vente/', 'A classer', 'needs_review', 'Archives des Commerce – Marketing – Vente - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat Créer un ', 'https://www.travail-burkina.com/category/offres-emploi/commerce-marketing-vente/', '2026-06-16T09:28:53.992Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('cebbafb153a3d573082dc2b441e415cd7ed24fc641a5d9132659a076aaf9129d', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Comptabilité – Finance – Statistiques', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/comptabilite-finance-statistiques/', 'A classer', 'needs_review', 'Archives des Comptabilité – Finance – Statistiques - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat ', 'https://www.travail-burkina.com/category/offres-emploi/comptabilite-finance-statistiques/', '2026-06-16T09:28:54.917Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('be79c8ec34aacada1b1b651665bed2ce18da5e9e3bae43e4471f7f6e93a57b51', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Conseil – Consulting', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/conseil-consulting/', 'A classer', 'needs_review', 'Archives des Conseil – Consulting - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat Créer un compte C', 'https://www.travail-burkina.com/category/offres-emploi/conseil-consulting/', '2026-06-16T09:28:56.121Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('854447717663b1e9427f6a1765682baef93714b72fed9ae734c5156f8bef951c', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Direction – Management', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/direction-management/', 'A classer', 'needs_review', 'Archives des Direction – Management - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat Créer un compte', 'https://www.travail-burkina.com/category/offres-emploi/direction-management/', '2026-06-16T09:28:57.042Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('340b89197b9e2d18f4c3d9ab98a88a9da361ad09a9b3d1344ac187d265348ffa', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Informatique – Télécom – Internet', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/informatique-telecom-internet/', 'A classer', 'needs_review', 'Archives des Informatique – Télécom – Internet - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat Crée', 'https://www.travail-burkina.com/category/offres-emploi/informatique-telecom-internet/', '2026-06-16T09:28:57.880Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('4a4aa5dfccba8c80ba9642bb902c373dd45fabeeb62ce0a2bc5b20a4e600024d', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Journalisme – Rédaction – Traduction', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/journalisme-redaction-traduction/', 'A classer', 'needs_review', 'Archives des Journalisme – Rédaction – Traduction - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat C', 'https://www.travail-burkina.com/category/offres-emploi/journalisme-redaction-traduction/', '2026-06-16T09:28:59.694Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('413b393c6a6479f397530b1e5f7e56dc33a8cdcd745d0d753966595faaa509a9', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Offres d’emploi Mécanique – Electrique – Energétique', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/mecanique-electrique-energetique/', 'A classer', 'needs_review', 'Archives des Mécanique – Electrique – Energétique - Emploi Burkina Faso Toggle navigation Accueil Offres d''emploi Toutes les offres Offres de stages Concours Fonction Publiques Immigration & Bourses Administration Agriculture – Agro-alimentaire Architecture Assistance – Secrétariat Audiovisuel- Infographie – Graphisme Biologie – Chimie Chargé de clientèle – Communication Commerce – Marketing – Vente Comptabilité – Finance – Statistiques Conseil – Consulting Direction – Management Formation – Education – Enseignement Freelance Informatique – Télécom – Internet Ingénierie – Industrie – Production Journalisme – Rédaction – Traduction Juridique Mécanique – Electrique – Energétique Médical – Paramedical Ressources Humaines Restauration – Hôtellerie Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support Textile – Styliste – Modéliste Vendeur- Ouvrier – Chauffeur Espace candidat C', 'https://www.travail-burkina.com/category/offres-emploi/mecanique-electrique-energetique/', '2026-06-16T09:29:01.438Z', 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7bd3b1a39a45995387a0037f637f2a8aa7e317311cb86e930bfa1d4718f4c50a', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Médical – Paramedical', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/medical-paramedical/', 'A classer', 'needs_review', null, 'https://www.travail-burkina.com/category/offres-emploi/medical-paramedical/', now(), 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('9ec08520e0b5fc9d5419b89302ca7722bf9974c51bc5a47ebc57f5ce643775f5', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Restauration – Hôtellerie', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/restauration-hotellerie/', 'A classer', 'needs_review', null, 'https://www.travail-burkina.com/category/offres-emploi/restauration-hotellerie/', now(), 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('60e2e04b8a299683932bdb27646fb605efe05939c1a751d18b1a5a9c966fa0c4', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Téléoperateurs – Téléconseillers – Télévendeurs – Technicien Support', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/teleoperateurs-teleconseillers-televendeurs-technicien-support/', 'A classer', 'needs_review', null, 'https://www.travail-burkina.com/category/offres-emploi/teleoperateurs-teleconseillers-televendeurs-technicien-support/', now(), 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('b3ade13dc1018ecdb247b99399d2bf5ac01730d6d9ce29420509933bb7f49d42', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Textile – Styliste – Modéliste', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/textile-styliste-modeliste/', 'A classer', 'needs_review', null, 'https://www.travail-burkina.com/category/offres-emploi/textile-styliste-modeliste/', now(), 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c7516a022645af25d2aa3c96f60bfa28447df0d313a4c2e64adac32a7b831dcb', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'Vendeur- Ouvrier – Chauffeur', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/category/offres-emploi/vendeur-ouvrier-chauffeur/', 'A classer', 'needs_review', null, 'https://www.travail-burkina.com/category/offres-emploi/vendeur-ouvrier-chauffeur/', now(), 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1800cdc36f70be3dddb6fb64d6041f88cfc7832db08178bf884eb0300184f863', 'travail-burkina', 'Travail Burkina', 'https://www.travail-burkina.com/', 'domaine d''activité', 'Travail Burkina', 'Burkina Faso', null, null, null, false, 'https://www.travail-burkina.com/offres-emploi-par-secteur-activite/', 'A classer', 'needs_review', null, 'https://www.travail-burkina.com/offres-emploi-par-secteur-activite/', now(), 0, 0, '2026-06-16T09:28:43.732Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c0052d4ade0d2e79f2bb0c76ababbc20e02355feebdfe6ecef99c19ff083f36f', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'RMO', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/flux-rss/filiales/cote-d-ivoire/offres.xml', 'A classer', 'needs_review', 'RMO - Cote d''Ivoire https://www.rmo-jobcenter.com/fr.html RMO - Cote d''Ivoire https://www.rmo-jobcenter.com/fr.html https://www.rmo-jobcenter.com/images/img/logo_mail.jpg Le numero 1 du recrutement en Afrique de l''Ouest Tue, 16 Jun 2026 09:29:34 GMT http://backend.userland.com/rss092 fr https://www.rmo-jobcenter.com/fr/cote-d-ivoire/offres-emploi/industrie-production-mat-1eres/4029-responsable-chaine-logistique.html https://www.rmo-jobcenter.com/fr/cote-d-ivoire/offres-emploi/industrie-production-mat-1eres/4029-responsable-chaine-logistique.html https://www.rmo-jobcenter.com/fr/cote-d-ivoire/offres-emploi/ntic/3971-ingenieur-support-data-center.html https://www.rmo-jobcenter.com/fr/cote-d-ivoire/offres-emploi/ntic/3971-ingenieur-support-data-center.html https://www.rmo-jobcenter.com/fr/cote-d-ivoire/offres-emploi/services/4002-chef-projet-it.html https://www.rmo-jobcenter.com/fr/cote-d-i', 'https://www.rmo-jobcenter.com/flux-rss/filiales/cote-d-ivoire/offres.xml', '2026-06-16T09:29:34.724Z', 0, 0, '2026-06-16T09:29:13.353Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7fe22ca82eda080d3850b31e5d512cb3b1d4e3b9182506967abd9784e698a311', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'ERREUR 404 : Page introuvable', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/industrie-production-mat-1eres/4029-responsable-chaine-logistique.html', 'A classer', 'needs_review', 'ERREUR 404 : Page introuvable A propos de RMO [+] Qui Sommes-Nous [+] Notre Savoir Faire [+] Nos Implantations [+] Nos Clients [+] Nos Partenaires [+] Actualit�s RMO [+] Nous Contacter Conseils Emploi [+] G�rer sa recherche d''emploi [+] Pr�parer son entretien d''embauche Diff�rents types d''entretien Le d�roulement de l''entretien Les erreurs � �viter lors d''un entretien de recrutement Quelques recommandations face au recruteur Exemples de questions de recruteurs Post-It � garder � ses c�t�s [+] L''entretien T�l�phonique Les appels � ne pas oublier Les attitudes � �viter [+] R�daction de son CV Construire sa strat�gie professionnelle Les parties principales d''un CV Les Diff�rents types de CV Recommandations et erreurs � �viter Les conseils � suivre Post-It � garder � ses c�t�s [+] La lettre de motivation Les erreurs � ne pas commettre Floril�ge des formulations � �viter [+] Choisir des Annon', 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/industrie-production-mat-1eres/4029-responsable-chaine-logistique.html', '2026-06-16T09:29:36.996Z', 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('5ec91e09f99631ffbc01b1b300dbd1d67d2e50fa5c01c2d1b30558b8ce02b751', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', '+d�tails', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/ntic/3971-ingenieur-support-data-center.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/ntic/3971-ingenieur-support-data-center.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('eefeedc3fdcf4d4b6373b0aa216c18915023e8607051200d8e1be144a621d8dc', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Operations Manager (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/mali/offres-emploi/services/4035-operations-manager.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/mali/offres-emploi/services/4035-operations-manager.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('eee428cf5817b0bb94044abab1ca98c9445072922734ee3fd1d9a1a477008731', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Commercial (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/mali/offres-emploi/services/4036-commercial.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/mali/offres-emploi/services/4036-commercial.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('0769c5c57a32e2ef556f765166e4f93d95af222c6298eac3d5fb0d24281167ad', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'AGENT CONTROLE DRAFT (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/mali/offres-emploi/ntic/4034-agent-controle-draft.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/mali/offres-emploi/ntic/4034-agent-controle-draft.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('76a313339992ae75e27e91cc7e06ea24568f13778f5c829e5aabe1237a73120f', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Chef de Projet IT (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/services/4002-chef-projet-it.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/services/4002-chef-projet-it.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('3cb6e5c553386f7e251f12310c0f629563b82378170930542faeb9f1de08d684', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'HSE (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/mali/offres-emploi/services/4033-hse.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/mali/offres-emploi/services/4033-hse.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('09ebbff177ac7f9e195fe01f0fa05be936cbaf90f7cd7978376fac5948199911', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Infographe / Webdesigner (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/mali/offres-emploi/services/4032-infographe-webdesigner.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/mali/offres-emploi/services/4032-infographe-webdesigner.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('565d6a2e9f57973024c3de485658f1971d50dfee048903e9a6081312cd0dafc3', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Office Manager (F/H) (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/services/4030-office-manager.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/services/4030-office-manager.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('f8cb467a8c551912f288e5eff28ec7cb209be78607cbbbeb100cc0027e5920c3', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Magasinier (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/industrie-production-mat-1eres/4027-magasinier.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/industrie-production-mat-1eres/4027-magasinier.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c147cfb03b07e3cd661470d5685d0836d12fd02419b3f6ab4d785b188aada049', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Responsable Administratif et Financier (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/services/4028-responsable-administratif.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/services/4028-responsable-administratif.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('bc075b55125c8e4a2d28c06f6a46abccfdf58c2c68514ea9bf7fba2fdfef2960', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Charg�(e) HSE (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/achat-logistique-transport/4023-charge-hse.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/achat-logistique-transport/4023-charge-hse.html', now(), 0, 0, '2026-06-16T09:29:13.354Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('26e1d106ef903b17633a273c12e7fd64055ce1b4ee18f0a7d98c4d92f0ab4db3', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Technico-commercial (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/ntic/3994-technico-commercial.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/ntic/3994-technico-commercial.html', now(), 0, 0, '2026-06-16T09:29:13.355Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('ac541f1960fa027e8608b494d2dcb36e813bc48e0f10421b1849daab164dd4de', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', '+d�tails', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/ntic/3994-technico-commercial.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/ntic/3994-technico-commercial.html', now(), 0, 0, '2026-06-16T09:29:13.355Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('19bc9fea06d35271a01e1f76e38427200b06729638c6d0feb108ba426dcd4eed', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Chef de produit Digital (H/F)', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/ntic/3817-chef-produit-digital.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/ntic/3817-chef-produit-digital.html', now(), 0, 0, '2026-06-16T09:29:13.355Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('5e496112a4b5851d964c1e627f45efd39987a0f1d436698cab67965136af9672', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', '+d�tails', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/ntic/3817-chef-produit-digital.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/cote-d-ivoire/offres-emploi/ntic/3817-chef-produit-digital.html', now(), 0, 0, '2026-06-16T09:29:13.355Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('64b6bf1ff012f888c77cbea5b7a45abf12a36640dd3567c2b2dbd9435f728e87', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Qui Sommes-Nous', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/rmo/qui-sommes-nous.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/rmo/qui-sommes-nous.html', now(), 0, 0, '2026-06-16T09:29:13.355Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('2e01e3bb59e70e1398d65f4c9fb3893b9313025e16a0852aa398ad7754e1f300', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Notre Savoir Faire', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/rmo/notre-savoir-faire.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/rmo/notre-savoir-faire.html', now(), 0, 0, '2026-06-16T09:29:13.355Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('a3890ab04a272e66e465eb7fedd0d1e6befba4924c0136fa107fb60de95f99d1', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Actualit�s RMO', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/rmo/actualites.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/rmo/actualites.html', now(), 0, 0, '2026-06-16T09:29:13.355Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('77d57f84d2ecf38bd22450731917b936026ab5f5b0b34aae40e2de0c3c3678ff', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Conseils Emploi', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/conseils-emploi.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/conseils-emploi.html', now(), 0, 0, '2026-06-16T09:29:13.355Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('2abffdfd7d7357848b5ab7631261b9ebb29a1554b3a135cbd09cc5ae9c4ec417', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Conna�tre ses Droits', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/connaitre-droits.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/connaitre-droits.html', now(), 0, 0, '2026-06-16T09:29:13.357Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('966a6473cb85ff338757aa10ba67a0ff7e5c987ed3d3f4a01862a2072c6e40e5', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Le Contrat de Mission', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/connaitre-droits/contrat-mission.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/connaitre-droits/contrat-mission.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('8516579301c555c46bd0811938e454bb3e3d93932f0814f1de0b547bcf8fde51', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Lexique Juridique', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/connaitre-droits/lexique-juridique.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/connaitre-droits/lexique-juridique.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('4a0f38934bb6c5af91992b353bb8481b254ec198984d04805f576fdd93bfdbc4', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Documentations L�gales', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/connaitre-droits/documentations-legales.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/connaitre-droits/documentations-legales.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('d95108c4f194130f563bc3ac0626d5a4fabd55229ca0c679809d5f4d184200a3', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Contr�le Qualit�', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/controle-qualite.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/controle-qualite.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('35d27e1259ba00a96dc35e573c9fd7dd4b1ad83be3af24be313a4dd5ede4d727', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Fiches M�tier', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/fiches-metier.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/fiches-metier.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('621a82e7e3e27d3bf1dedd8eabd4012efb74b4f71bd8261358abff98a924ba15', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Actu Conseil', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/actu-conseils.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/conseils-emploi/actu-conseils.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('3f34dc55f5b39ff7a29e54c69a5b3106307a8e5359bfe6826dd383760c28fc59', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'D�p�t de CV', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/depot-cv.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/depot-cv.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('22fe8d9b2824b86ce4bc46a91fd645482cbd1a9c23a21831ee33e618bcbac724', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Agent de recherche', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/agent-recherche.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/agent-recherche.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('17a1dcd594f86916c080ffc57b704feb20af2860a37b6820d03a2534b886fef7', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Tests RH', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/tests-rh.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/tests-rh.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('bce8afd74846a248a7c4b2c7199f3ae6d04716bbb9f80be6a3e41731baadbc73', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Boite � outils', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/boite-outils.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/boite-outils.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('9dc18d4ee141795bd47ae16e4ee0c9b498de320714884be2effc36d6832a623b', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Conseil juridique', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/boite-outils/conseil-juridique.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/boite-outils/conseil-juridique.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c69cd620aedf5e865d28943da6756ea194d532359d36605a149753be68adcea1', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Questions-r�ponses', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/questions-reponses.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/questions-reponses.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('a70552f27b42307e6d8033897f569defd1ece938afdef40e6145e5b1a5c85046', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Demande de documents', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/demande-documents.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/candidats/demande-documents.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('92f6766a9a3f1a5b612aeb2a120c2e1dda9126c2fa95fd05c552a9ed7d65c49d', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Nos Services', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('91c2e13d6f50bd97529d4506fcc73b60ea375a78c66e6c4ec1ea33b0fa8e2816', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Recrutement', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/recrutement.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/recrutement.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1b883d94f2ccc39c68b37e67a13f3764c77f3529df520ebab63938d73ba536d3', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Nos Offres', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/recrutement/nos-offres.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/recrutement/nos-offres.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('825f06e4d7aa69ccf9d3100801b6a929938ed4d92d90e9ac0bc9fd589a5b5867', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Notre Agr�ment', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/recrutement/notre-agrement.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/recrutement/notre-agrement.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('5069a18bc17905f920fddf92df9ceb6d045add234ffc47f0226f4edc88db409b', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Nos tests RH avec Central Test', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/recrutement/nos-tests-rh.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/recrutement/nos-tests-rh.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('935d3467af0f2ad0cc5cbb236de2b64cb7edf87c513d3461827face59a1bdbc5', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Travail Temporaire', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/travail-temporaire.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/travail-temporaire.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('2663bed0c39ce0e336b2cf3c705dcfa761f85228a223b9552f471120a745aa27', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Le Contrat de Mission', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/travail-temporaire/contrat-mission.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/travail-temporaire/contrat-mission.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1f08f0bdd86045fe74c1be10e78999ec9f315949d931c77426fe3c4714ba8512', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Notre Agr�ment', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/travail-temporaire/notre-agrement.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/travail-temporaire/notre-agrement.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('47b19571fddd78edbdd845bdae079439f595e1f84d075c15996b1cc0215d592b', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Sous Traitance', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/sous-traitance.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/sous-traitance.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('0ffc5df8a49e9720bdf98da78282696582b8a91b6fcdbfb83b2e5c0bfafd0827', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Notre Agr�ment', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/sous-traitance/notre-agrement.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/sous-traitance/notre-agrement.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('6936ed394eb5fd81ccc81348b5bc526da823ae11f1553fde6c17e4e8555e2194', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Notre Agr�ment', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/formation/notre-agrement.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/formation/notre-agrement.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('21462ca4a00c56eec090cce13c8804dc0116879bf3032949f98d664f7ee4397e', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Conseil RH', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/conseil-rh.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/conseil-rh.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('be9b479e6137f5977a318813f95ad27330cf8ec35ae6b5958708057c836885d1', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Notre Agr�ment', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/conseil-rh/notre-agrement.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/nos-services/conseil-rh/notre-agrement.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('f3a63f5c1381e66089d0d6469b32d6512256f7ae92de96d232a0026a5383f71d', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'T�moignages Clients', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/temoignages.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/temoignages.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c90a73aa45d8fa32704a7586ad2c0a98daaff02f86bf3b2bfac10b2d9c59c9c4', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Demande de Cotation Express', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/demande-cotation-express.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/demande-cotation-express.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('fa5ec49d04977a577c542e6e464a5c89f912cd499594d3e0b91df2c727b08828', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Service Web', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/service-web.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/cote-d-ivoire/entreprises/service-web.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('3bd992090ff9e05604cd2fa51708a8b51f4862aaaa22f272556812ffde76ff6c', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Politique de Confidentialit�', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/politique-confidentialite.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/politique-confidentialite.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('3daa83ca29f6070345777c046bde2c0122ca6dd34e5367ac2f03bcacd9817ac3', 'rmo-burkina', 'RMO Job Center', 'https://www.rmo-jobcenter.com/fr/nos-offres-emploi.html', 'Politique de Gestion des Cookies', 'RMO Job Center', 'Burkina Faso', null, null, null, false, 'https://www.rmo-jobcenter.com/fr/fr/politique-cookie.html', 'A classer', 'needs_review', null, 'https://www.rmo-jobcenter.com/fr/fr/politique-cookie.html', now(), 0, 0, '2026-06-16T09:29:13.358Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('b7c08b4b8d89ead777c83e8353e6dcdbf8c315c94d64e8f944b31b6670da5551', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'RESPONSABLE DE LA QUALITÉ DES SOINS DES CENTRES DE SANTÉ', 'HumanitaireHub', 'Burkina Faso', '2026-06-28', null, '2026-06-28', false, 'https://humanitairehub.com/emploi/responsable-de-la-qualite-des-soins-des-centres-de-sante/', 'A classer', 'needs_review', 'RESPONSABLE DE LA QUALITÉ DES SOINS DES CENTRES DE SANTÉ - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion RESPONSABLE DE LA QUALITÉ DES SOINS DES CENTRES DE SANTÉ ← Retour aux offres ONG MUSO RESPONSABLE DE LA QUALITÉ DES SOINS DES CENTRES DE SANTÉ 📍 Côte d''Ivoire · 📄 CDD ⏰ Deadline 28 Juin 2026 J-12 📧 Postuler par email → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale Santé Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste Informations sur l’emploi Titre du Poste : RESPONSABLE DE LA QUALITÉ DES SOINS DES CENTRES DE SANTÉ Lieu du Travail : Côte d&rsquo;Ivoire Description de l’emploi Chez Muso , notre engagement envers la justice nous pousse à garantir la gratuité totale des s', 'https://humanitairehub.com/emploi/responsable-de-la-qualite-des-soins-des-centres-de-sante/', '2026-06-16T09:29:51.209Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c53390db700180a3fc2e9b0c65d6adb795ebfb7ff4429e18470230774e1a57c4', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'RESPONSABLE DE LA QUALITÉ DES SOINS DES CENTRES DE SANTÉ', 'HumanitaireHub', 'Burkina Faso', '2026-06-28', null, '2026-06-28', false, 'https://humanitairehub.com/emploi/responsable-de-la-qualite-des-soins-des-centres-de-sante/', 'A classer', 'needs_review', 'RESPONSABLE DE LA QUALITÉ DES SOINS DES CENTRES DE SANTÉ - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion RESPONSABLE DE LA QUALITÉ DES SOINS DES CENTRES DE SANTÉ ← Retour aux offres ONG MUSO RESPONSABLE DE LA QUALITÉ DES SOINS DES CENTRES DE SANTÉ 📍 Côte d''Ivoire · 📄 CDD ⏰ Deadline 28 Juin 2026 J-12 📧 Postuler par email → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale Santé Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste Informations sur l’emploi Titre du Poste : RESPONSABLE DE LA QUALITÉ DES SOINS DES CENTRES DE SANTÉ Lieu du Travail : Côte d&rsquo;Ivoire Description de l’emploi Chez Muso , notre engagement envers la justice nous pousse à garantir la gratuité totale des s', 'https://humanitairehub.com/emploi/responsable-de-la-qualite-des-soins-des-centres-de-sante/', '2026-06-16T09:29:52.030Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('599fc20547fbeefb9012f99ad514616c25e2d84223e0c87f2a526c82e82d45f0', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL)', 'HumanitaireHub', 'Burkina Faso', '2026-06-23', null, '2026-06-23', false, 'https://humanitairehub.com/emploi/charge-de-securite-et-logistique-national/', 'A classer', 'needs_review', 'CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) ← Retour aux offres WeWorld CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) 📍 Burkina Faso · 📄 CDD ⏰ Deadline 23 Juin 2026 J-7 📧 Postuler par email → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale Logistique Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste 📋 Informations clés Lieu Burkina-Faso Pays Burkina-Faso Date de clôture 23 juin 2026 Organisation WeWorld WeWorld est une organisation laïque et indépendante italienne active depuis 1971 dans la coopération internationale et l’aide humanitaire. I- CONDITIONS DE TRAVAIL ET REMUNERATION ', 'https://humanitairehub.com/emploi/charge-de-securite-et-logistique-national/', '2026-06-16T09:29:53.070Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('73a9d6a82271f90a48708636ff2cd12510013f88e716751545c9901e95136887', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL)', 'HumanitaireHub', 'Burkina Faso', '2026-06-23', null, '2026-06-23', false, 'https://humanitairehub.com/emploi/charge-de-securite-et-logistique-national/', 'A classer', 'needs_review', 'CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) ← Retour aux offres WeWorld CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) 📍 Burkina Faso · 📄 CDD ⏰ Deadline 23 Juin 2026 J-7 📧 Postuler par email → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale Logistique Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste 📋 Informations clés Lieu Burkina-Faso Pays Burkina-Faso Date de clôture 23 juin 2026 Organisation WeWorld WeWorld est une organisation laïque et indépendante italienne active depuis 1971 dans la coopération internationale et l’aide humanitaire. I- CONDITIONS DE TRAVAIL ET REMUNERATION ', 'https://humanitairehub.com/emploi/charge-de-securite-et-logistique-national/', '2026-06-16T09:29:54.080Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('ae3517bc400a6a3b8f780fcc77a1f628bcbda13b4db3de00c3cf0a899a92b1f7', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', '4 Ingénieur associé (Technicien d&rsquo;installation de préfabriqués/MSU)', 'HumanitaireHub', 'Burkina Faso', '2026-06-22', null, '2026-06-22', false, 'https://humanitairehub.com/emploi/4-ingenieur-associe-technicien-dinstallation-de-prefabriques-msu/', 'A classer', 'needs_review', '4 Ingénieur associé (Technicien d''installation de préfabriqués/MSU) - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion 4 Ingénieur associé (Technicien d&rsquo;installation de préfabriqués/MSU) ← Retour aux offres CTG 4 Ingénieur associé (Technicien d&rsquo;installation de préfabriqués/MSU) 📍 Bunia et Beni, RD Congo · 📄 CDD ⏰ Deadline 22 Juin 2026 J-6 📨 Postuler maintenant → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale 📅 Début 01 Juil 2026 Shelter WASH (Eau, Hygiène, Assainissement) Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste Détails du poste Numéro de poste vacant VAC-58608 Titre d’emploi VAC-58608 Ingénieur associé (Technicien d&rsquo;installation de préfabriqués/MSU)', 'https://humanitairehub.com/emploi/4-ingenieur-associe-technicien-dinstallation-de-prefabriques-msu/', '2026-06-16T09:29:54.840Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('e817b886d37a943d66d9a8f435e545b3bee10d57cc6829ad32234cd2467fc7ef', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', '4 Ingénieur associé (Technicien d&rsquo;installation de préfabriqués/MSU)', 'HumanitaireHub', 'Burkina Faso', '2026-06-22', null, '2026-06-22', false, 'https://humanitairehub.com/emploi/4-ingenieur-associe-technicien-dinstallation-de-prefabriques-msu/', 'A classer', 'needs_review', '4 Ingénieur associé (Technicien d''installation de préfabriqués/MSU) - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion 4 Ingénieur associé (Technicien d&rsquo;installation de préfabriqués/MSU) ← Retour aux offres CTG 4 Ingénieur associé (Technicien d&rsquo;installation de préfabriqués/MSU) 📍 Bunia et Beni, RD Congo · 📄 CDD ⏰ Deadline 22 Juin 2026 J-6 📨 Postuler maintenant → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale 📅 Début 01 Juil 2026 Shelter WASH (Eau, Hygiène, Assainissement) Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste Détails du poste Numéro de poste vacant VAC-58608 Titre d’emploi VAC-58608 Ingénieur associé (Technicien d&rsquo;installation de préfabriqués/MSU)', 'https://humanitairehub.com/emploi/4-ingenieur-associe-technicien-dinstallation-de-prefabriques-msu/', '2026-06-16T09:29:55.711Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('f66f33f4ac4ca14fe3508f1e418104e80f964a9568b318aedf1c1840e8b9af9f', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Pédiatre Référent (HF)', 'HumanitaireHub', 'Burkina Faso', '2026-06-22', null, '2026-06-22', false, 'https://humanitairehub.com/emploi/pediatre-referent-hf/', 'A classer', 'needs_review', 'Pédiatre Référent (HF) - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion Pédiatre Référent (HF) ← Retour aux offres International Rescue Committee (IRC) Pédiatre Référent (HF) 📍 Burkina Faso · 📄 CDD ⏰ Deadline 22 Juin 2026 J-6 📨 Postuler maintenant → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale Management & Coordination Protection, Genre & Inclusion Santé Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste 📋 Informations clés Lieu Burkina Faso Pays Burkina Faso Date de clôture 22 juin 2026 Organisation IRC Le Comité international de secours (IRC) intervient lors des crises humanitaires les plus graves au monde, contribuant à rétablir la santé, la sécurité, l’éducation, le bie', 'https://humanitairehub.com/emploi/pediatre-referent-hf/', '2026-06-16T09:29:56.646Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7d002bc9bbc600ba09e40b1862afdc48933d5f7c6e8549eb56735723e83b04fd', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Pédiatre Référent (HF)', 'HumanitaireHub', 'Burkina Faso', '2026-06-22', null, '2026-06-22', false, 'https://humanitairehub.com/emploi/pediatre-referent-hf/', 'A classer', 'needs_review', 'Pédiatre Référent (HF) - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion Pédiatre Référent (HF) ← Retour aux offres International Rescue Committee (IRC) Pédiatre Référent (HF) 📍 Burkina Faso · 📄 CDD ⏰ Deadline 22 Juin 2026 J-6 📨 Postuler maintenant → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale Management & Coordination Protection, Genre & Inclusion Santé Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste 📋 Informations clés Lieu Burkina Faso Pays Burkina Faso Date de clôture 22 juin 2026 Organisation IRC Le Comité international de secours (IRC) intervient lors des crises humanitaires les plus graves au monde, contribuant à rétablir la santé, la sécurité, l’éducation, le bie', 'https://humanitairehub.com/emploi/pediatre-referent-hf/', '2026-06-16T09:29:57.299Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('185f5274e03480dc2b649ab1c9358f2bbf9a2c34841d62440b666356b0f8c816', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Stagiaire Logistique & Finance', 'HumanitaireHub', 'Burkina Faso', '2026-06-24', null, '2026-06-24', false, 'https://humanitairehub.com/emploi/stagiaire-logistique-finance/', 'A classer', 'needs_review', 'Stagiaire Logistique & Finance - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion Stagiaire Logistique & Finance ← Retour aux offres Search for Common Ground (Search) Stagiaire Logistique & Finance 📍 Mali · 📄 Stage ⏰ Deadline 24 Juin 2026 J-8 📨 Postuler maintenant → 📊 Expérience Junior (0-2 ans) 🏢 Type d''org Organisation Internationale Administration & Finance Logistique Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste Informations sur le stage Titre du Poste : Stagiaire Logistique & Finance Pays / Lieu du Stage : Mali Description de l&rsquo;offre de stage Search for Common Ground (Search) est une organisation internationale non gouvernementale engagée dans la transformation des conflits. Fondée en 198', 'https://humanitairehub.com/emploi/stagiaire-logistique-finance/', '2026-06-16T09:29:58.479Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('d7b3f0f2e6af2fe7926cc59e3d936a418aa443800b20dacbaf95e87cb8b131a5', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Stagiaire Logistique & Finance', 'HumanitaireHub', 'Burkina Faso', '2026-06-24', null, '2026-06-24', false, 'https://humanitairehub.com/emploi/stagiaire-logistique-finance/', 'A classer', 'needs_review', 'Stagiaire Logistique & Finance - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion Stagiaire Logistique & Finance ← Retour aux offres Search for Common Ground (Search) Stagiaire Logistique & Finance 📍 Mali · 📄 Stage ⏰ Deadline 24 Juin 2026 J-8 📨 Postuler maintenant → 📊 Expérience Junior (0-2 ans) 🏢 Type d''org Organisation Internationale Administration & Finance Logistique Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste Informations sur le stage Titre du Poste : Stagiaire Logistique & Finance Pays / Lieu du Stage : Mali Description de l&rsquo;offre de stage Search for Common Ground (Search) est une organisation internationale non gouvernementale engagée dans la transformation des conflits. Fondée en 198', 'https://humanitairehub.com/emploi/stagiaire-logistique-finance/', '2026-06-16T09:30:01.347Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('61dfe85443a471f51e0a2ccc8d3f37683c8435a803ac132a91e9e6833a34b051', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'ATBEF recrute 02 postes', 'HumanitaireHub', 'Burkina Faso', '2026-06-30', '2026-06-30', '2026-06-30', false, 'https://humanitairehub.com/emploi/atbef-recrute-02-postes/', 'A classer', 'needs_review', 'ATBEF recrute 02 postes - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion ATBEF recrute 02 postes ← Retour aux offres ATBEF ATBEF recrute 02 postes 📍 Togo · 📄 CDD ⏰ Deadline 30 Juin 2026 J-14 📧 Postuler par email → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org ONG Nationale Plusieurs Secteurs Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste Informations sur l’emploi Titre du Poste : 2 postes Lieu du Travail : Togo Date de Soumission : 30/06/2026 Description de l’emploi Dans le cadre de l’exécution de son projet « Renforcement de la Gouvernance et de la Qualité des Services de Base par la Participation Citoyenne au Togo » co-financé par l’Union Européenne et la DAHW, l’Association Togolaise pour le Bien', 'https://humanitairehub.com/emploi/atbef-recrute-02-postes/', '2026-06-16T09:30:01.960Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('933ec22987180a96459cdabfaa39e8f0c0d96e5224c41f727307d58b193e474e', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'ATBEF recrute 02 postes', 'HumanitaireHub', 'Burkina Faso', '2026-06-30', '2026-06-30', '2026-06-30', false, 'https://humanitairehub.com/emploi/atbef-recrute-02-postes/', 'A classer', 'needs_review', 'ATBEF recrute 02 postes - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion ATBEF recrute 02 postes ← Retour aux offres ATBEF ATBEF recrute 02 postes 📍 Togo · 📄 CDD ⏰ Deadline 30 Juin 2026 J-14 📧 Postuler par email → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org ONG Nationale Plusieurs Secteurs Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste Informations sur l’emploi Titre du Poste : 2 postes Lieu du Travail : Togo Date de Soumission : 30/06/2026 Description de l’emploi Dans le cadre de l’exécution de son projet « Renforcement de la Gouvernance et de la Qualité des Services de Base par la Participation Citoyenne au Togo » co-financé par l’Union Européenne et la DAHW, l’Association Togolaise pour le Bien', 'https://humanitairehub.com/emploi/atbef-recrute-02-postes/', '2026-06-16T09:30:02.592Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('486199dccaee888c603f926b8f90d3869d7d759e98edaa8032bce74a034c7f34', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Spécialiste en communication', 'HumanitaireHub', 'Burkina Faso', '2026-06-22', null, '2026-06-22', false, 'https://humanitairehub.com/emploi/specialiste-en-communication/', 'A classer', 'needs_review', 'Spécialiste en communication - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion Spécialiste en communication ← Retour aux offres PNUD / UNDP Spécialiste en communication 📍 Sénégal · 📄 CDD ⏰ Deadline 22 Juin 2026 J-6 📨 Postuler maintenant → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Agence des Nations Unies Communication Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste 📢 Offre d’emploi : Spécialiste en communication – PNUD Sénégal 📍 Lieu : Sénégal 🎓 Niveau requis : Licence ou Master 📈 Expérience requise : 5 ans (avec Master) ou 7 ans (avec Licence) 📅 Date limite de candidature : Avant le 23 juin 2026 Le PNUD est le réseau mondial de développement des Nations Unies. Il œuvre pour le changement et ', 'https://humanitairehub.com/emploi/specialiste-en-communication/', '2026-06-16T09:30:03.731Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('e8da1f8803506a54b33ff7292df17633624b7be986b0f97ea8d357e8d9fa43a8', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Spécialiste en communication', 'HumanitaireHub', 'Burkina Faso', '2026-06-22', null, '2026-06-22', false, 'https://humanitairehub.com/emploi/specialiste-en-communication/', 'A classer', 'needs_review', 'Spécialiste en communication - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion Spécialiste en communication ← Retour aux offres PNUD / UNDP Spécialiste en communication 📍 Sénégal · 📄 CDD ⏰ Deadline 22 Juin 2026 J-6 📨 Postuler maintenant → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Agence des Nations Unies Communication Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste 📢 Offre d’emploi : Spécialiste en communication – PNUD Sénégal 📍 Lieu : Sénégal 🎓 Niveau requis : Licence ou Master 📈 Expérience requise : 5 ans (avec Master) ou 7 ans (avec Licence) 📅 Date limite de candidature : Avant le 23 juin 2026 Le PNUD est le réseau mondial de développement des Nations Unies. Il œuvre pour le changement et ', 'https://humanitairehub.com/emploi/specialiste-en-communication/', '2026-06-16T09:30:04.382Z', 0, 0, '2026-06-16T09:29:49.907Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('eb1b5715c15ea98009e6324550ff5da11e1aef822406635c18c21b7a165cff03', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'ACF recrute 05 postes', 'HumanitaireHub', 'Burkina Faso', '2026-06-23', '2026-07-01', '2026-06-23', false, 'https://humanitairehub.com/emploi/acf-recrute-05-postes/', 'A classer', 'needs_review', 'ACF recrute 05 postes - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion ACF recrute 05 postes ← Retour aux offres Action Contre la Faim ACF recrute 05 postes 📍 Cameroun · 📄 CDD ⏰ Deadline 23 Juin 2026 J-7 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale 📅 Début 01 Juil 2026 Plusieurs Secteurs Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste Informations sur les postes disponibles Titre du Poste : 05 postes Lieu du Travail : Cameroun Description de l’emploi Créée en 1979, Action contre la Faim est une organisation non gouvernementale internationale qui lutte contre la faim dans le monde. Sa charte des principes humanitaires – indépendance, neutralité, non-discrimination, accès l', 'https://humanitairehub.com/emploi/acf-recrute-05-postes/', '2026-06-16T09:30:05.053Z', 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('120b9ee386b12f15b79577d2c68d1c35a03b145fd881c23708521a84a73dcc2b', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'ACF recrute 05 postes', 'HumanitaireHub', 'Burkina Faso', '2026-06-23', '2026-07-01', '2026-06-23', false, 'https://humanitairehub.com/emploi/acf-recrute-05-postes/', 'A classer', 'needs_review', 'ACF recrute 05 postes - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion ACF recrute 05 postes ← Retour aux offres Action Contre la Faim ACF recrute 05 postes 📍 Cameroun · 📄 CDD ⏰ Deadline 23 Juin 2026 J-7 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale 📅 Début 01 Juil 2026 Plusieurs Secteurs Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste Informations sur les postes disponibles Titre du Poste : 05 postes Lieu du Travail : Cameroun Description de l’emploi Créée en 1979, Action contre la Faim est une organisation non gouvernementale internationale qui lutte contre la faim dans le monde. Sa charte des principes humanitaires – indépendance, neutralité, non-discrimination, accès l', 'https://humanitairehub.com/emploi/acf-recrute-05-postes/', '2026-06-16T09:30:07.622Z', 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1018969170ab4d6b7d8efd816afa8adaa2add8ff51d571039b34a5611b904fbb', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'ONG World Vision 02 postes', 'HumanitaireHub', 'Burkina Faso', '2026-06-25', null, '2026-06-25', false, 'https://humanitairehub.com/emploi/ong-world-vision-02-postes/', 'A classer', 'needs_review', 'ONG World Vision 02 postes - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion ONG World Vision 02 postes ← Retour aux offres World Vision ONG World Vision 02 postes 📍 Tchad/Rwanda · 📄 CDD ⏰ Deadline 25 Juin 2026 J-9 📨 Postuler maintenant → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale Management & Coordination Plusieurs Secteurs Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste 🌍 Informations sur l’emploi 📌 Titre du Poste : 02 Lieu du Travail : Rwanda, Tchad 🌐 À propos de World Vision Forts de 75 ans d’expérience, l’ONG World Vision s’engage à aider les enfants les plus vulnérables à sortir de la pauvreté et à s’épanouir pleinement. Elle accompagne des enfants de tous horiz', 'https://humanitairehub.com/emploi/ong-world-vision-02-postes/', '2026-06-16T09:30:08.799Z', 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('865f43d0f69705c04e104d484e125866d00d90c9c3f5009c49d87c20a8213873', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'ONG World Vision 02 postes', 'HumanitaireHub', 'Burkina Faso', '2026-06-25', null, '2026-06-25', false, 'https://humanitairehub.com/emploi/ong-world-vision-02-postes/', 'A classer', 'needs_review', 'ONG World Vision 02 postes - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion ONG World Vision 02 postes ← Retour aux offres World Vision ONG World Vision 02 postes 📍 Tchad/Rwanda · 📄 CDD ⏰ Deadline 25 Juin 2026 J-9 📨 Postuler maintenant → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale Management & Coordination Plusieurs Secteurs Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste 🌍 Informations sur l’emploi 📌 Titre du Poste : 02 Lieu du Travail : Rwanda, Tchad 🌐 À propos de World Vision Forts de 75 ans d’expérience, l’ONG World Vision s’engage à aider les enfants les plus vulnérables à sortir de la pauvreté et à s’épanouir pleinement. Elle accompagne des enfants de tous horiz', 'https://humanitairehub.com/emploi/ong-world-vision-02-postes/', '2026-06-16T09:30:09.494Z', 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('17c07c453b34aadca59cb0f40b16d1f6aff871a67b6a5552b78435fc6f9aa374', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Expertise France J-14 Coordinateur.rice national.e Guinée (H/F) 📍 Guinée Management & Coordination Plusieurs Secteurs', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/coordinateur-rice-national-e-guinee-h-f/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/coordinateur-rice-national-e-guinee-h-f/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('25db1166246a2299d52e38117271e4981d5468256231e10b93928e358fbc7eae', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/coordinateur-rice-national-e-guinee-h-f/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/coordinateur-rice-national-e-guinee-h-f/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('9f611900dcd0993d8b93072dd73e42bc106b44960611e45fdbd7cc32f5dfce43', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'UNICEF J-13 Gestionnaire de chaine d’approvisionnement des intrants de nutrition 📍 Burkina Faso Logistique', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/gestionnaire-de-chaine-dapprovisionnement-des-intrants-de-nutrition/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/gestionnaire-de-chaine-dapprovisionnement-des-intrants-de-nutrition/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('5f3e1e690ed7a100297d7cc016f0254b223fba9e0ecb4bfcd209c0079a220fe9', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/gestionnaire-de-chaine-dapprovisionnement-des-intrants-de-nutrition/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/gestionnaire-de-chaine-dapprovisionnement-des-intrants-de-nutrition/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('cbb46c80818fa15b1f513dc29bf1f033c8643c25571690639bcd6238585a5c16', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Catholic Relief Services (CRS) Dernier jour ! CRS recrute 03 postes (Urgent) 📍 RD Congo 📋 CDD Plusieurs Secteurs', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/crs-recrute-03-postes-urgent/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/crs-recrute-03-postes-urgent/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('e350fef31c13c2a3dd2227f302df0923d5580ee6d362b9ddfa41006a92e61616', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/crs-recrute-03-postes-urgent/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/crs-recrute-03-postes-urgent/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('eea1da6ee6204416399d7bbe9de19afc2e1f540c605ac1210da5ffec8ca784c5', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'ALIMA J-20 Gestionnaire Projet Consortium &#8211; Bunia &#8211; RDC &#8211; H/F 📍 RD Congo 📋 CDD Management & Coordination', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/gestionnaire-projet-consortium-bunia-rdc-h-f/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/gestionnaire-projet-consortium-bunia-rdc-h-f/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('4f3a00546c67e5960ec9bc58b068a5d2dcad09160fe90153a2c73322a9cb5344', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/gestionnaire-projet-consortium-bunia-rdc-h-f/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/gestionnaire-projet-consortium-bunia-rdc-h-f/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('c3d9cacb09825cd071a9cce4e479262ad2bb7883d7760dc099020b6348f97d6e', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'ACTED J-29 Directeur.trice de Projet Climat et Environnement – ​​N&rsquo;Djaména 📍 Tchad 📋 CDD Environnement & Climat', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/directeur-trice-de-projet-climat-et-environnement-ndjamena/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/directeur-trice-de-projet-climat-et-environnement-ndjamena/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('a9e0aa0fa0cf81602a9adc4401042178063723176ea87f9bdc48157139b85d74', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/directeur-trice-de-projet-climat-et-environnement-ndjamena/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/directeur-trice-de-projet-climat-et-environnement-ndjamena/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1c4b859e4df8c4d646a5ca62bdd826fdbd0ecfa76765c5d68107415806189bf9', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'ACTED J-29 Responsable de Projet Climat &#038; Environnement – Adré 📍 Tchad 📋 CDD Environnement & Climat', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/responsable-de-projet-climat-environnement-adre/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/responsable-de-projet-climat-environnement-adre/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('43e6cee01b0809b5bd8272a351eb2d5c4c59122d5084fa296515d32f2d2ea712', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/responsable-de-projet-climat-environnement-adre/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/responsable-de-projet-climat-environnement-adre/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('319e49e1f9815ac18534d86ccbdd591ffb268da964136b33518fd33a9cbf78af', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/evaluateur-expert-en-consolidation-de-la-paix-et-en-acces-a-la-justice/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/evaluateur-expert-en-consolidation-de-la-paix-et-en-acces-a-la-justice/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('18c66680f017d1d255c4eed911e23e0193db0e68abc52500fb980a3d13e714de', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'COOPI - Cooperazione Internazionale J-20 COOPI recherche un Chef de Mission au Niger 📍 Niger 📋 CDD Management & Coordination', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/coopi-recherche-un-chef-de-mission-au-niger/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/coopi-recherche-un-chef-de-mission-au-niger/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7ac130ae7427017c90484249e7321d620143c61e341b6806c0e9af9b698a9a65', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/coopi-recherche-un-chef-de-mission-au-niger/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/coopi-recherche-un-chef-de-mission-au-niger/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('7f1004444c26b32f322a235228270414fddfbd6851c6ba485a376c95311dc795', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'OIM / IOM J-5 Associé(e) Senior aux Opérations de Mouvement (Appui Terrain)_G.6) 📍 Côte d''Ivoire 📋 CDD Administration & Finance Logistique', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/associee-senior-aux-operations-de-mouvement-appui-terrain_g-6/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/associee-senior-aux-operations-de-mouvement-appui-terrain_g-6/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('ad031b5a87a0c89adc97a32cfa3e42064237b02923bd29e79af4efa82e36408c', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/associee-senior-aux-operations-de-mouvement-appui-terrain_g-6/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/associee-senior-aux-operations-de-mouvement-appui-terrain_g-6/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('55663395714dacccaf803d2e90b6339f5f3648be066bd3914d22391f905da315', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'UNICEF J-13 UNICEF recrute 02 postes 📍 Sénégal/RDC 📋 CDD Plusieurs Secteurs', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/unicef-recrute-02-postes-3/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/unicef-recrute-02-postes-3/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('e9cec341e538ad9c335a310c805424fecee79494d2a33a7687afef4e5018aaed', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/unicef-recrute-02-postes-3/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/unicef-recrute-02-postes-3/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('3e19a859e7d28900d4bc4a58747264ef7c516c919e0335e5a2e186418c80ad93', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'PAM (Programme Alimentaire Mondial) J-13 PAM recrute Associé au programme SC6 📍 Tchad 📋 CDD Plusieurs Secteurs', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/pam-recrute-associe-au-programme-sc6/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/pam-recrute-associe-au-programme-sc6/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('58a6678a1e7e8723aef4e9055f9e14e922330d0227b7a7559c7db0add4163726', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/pam-recrute-associe-au-programme-sc6/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/pam-recrute-associe-au-programme-sc6/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1b6d4a19939ee106d664e30d1f7c2868e656ad015b431e2ec44cffa87a7ac394', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'International Cocoa Initiative (ICI) J-14 Développeur.euse Senior d&rsquo;application web et mobiles (Spécialiste) 📍 Côte d''Ivoire 📋 CDD Technologies & Innova', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/developpeur-euse-senior-dapplication-web-et-mobiles-specialiste/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/developpeur-euse-senior-dapplication-web-et-mobiles-specialiste/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('bc94a41ccf634b4c2c450a7dae0eb7fbce635d5e91361acd058aa09dd554d651', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/developpeur-euse-senior-dapplication-web-et-mobiles-specialiste/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/developpeur-euse-senior-dapplication-web-et-mobiles-specialiste/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('0e526ec3ecf8c035ad2ca77961786072c536d6d833cb52dfc448734a6dacd6aa', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Oxfam International J-13 OORDONNATEUR DE PROGRAMME DU SECTEUR PRIVÉ, 📍 Ghana 📋 CDD Management & Coordination', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/oordonnateur-de-programme-du-secteur-prive/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/oordonnateur-de-programme-du-secteur-prive/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('76786722b82f23bda5ed16e13c78a35a028734ec46900033b659f999ed8e2067', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/oordonnateur-de-programme-du-secteur-prive/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/oordonnateur-de-programme-du-secteur-prive/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('e03cf889788309660fc928f8c7672a0ac3b8000e7a951b31cc7409f5b551541c', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'UNHCR J-13 HCR recrute 500 Volontaires en ligne 📍 Mali 📋 Volontariat (VSI, VNU, etc.) Plusieurs Secteurs', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/hcr-recrute-500-volontaires-en-ligne/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/hcr-recrute-500-volontaires-en-ligne/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('cc478a42e1d3746ce708b32e943779def5ef973c9deb99bcd8f04f25cedc3cb7', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/hcr-recrute-500-volontaires-en-ligne/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/hcr-recrute-500-volontaires-en-ligne/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('0c43a728a7e3d8c23a6e737b9599a2f2646d40126ee77aa716d8ea6b9b26f98f', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'MONUSCO J-2 Directeur de l&rsquo;appui à la mission, D2 📍 RD Congo Plusieurs Secteurs', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/directeur-de-lappui-a-la-mission-d2/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/directeur-de-lappui-a-la-mission-d2/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('102d52108368b659883b59b42f00e8a34f580daf5a8f34292fb8533dcae816f3', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/directeur-de-lappui-a-la-mission-d2/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/directeur-de-lappui-a-la-mission-d2/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('d32d1c7504c4e82b6c7e70a3cd3d71da43cc0de9e037f5c08d51e8c8b913a388', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'OIBT J-4 Programme de bourses de l&rsquo;OIBT 📍 Pays Membres de l''OIBT 📋 Bourses/Etudes Plusieurs Secteurs', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/programme-de-bourses-de-loibt/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/programme-de-bourses-de-loibt/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('f767a691d7239b0e52e713b0b0c5747dce42273a8a1c4903ba54cad66fa8a3e0', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/programme-de-bourses-de-loibt/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/programme-de-bourses-de-loibt/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('34c96ce73f77988706aae95429e85338b853a525556db65f898a1b869b655869', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Expertise France Non precisee Chargé.e SERA_ Projet ATINORD Sécurité (H/F) 📍 Côte d''Ivoire 📋 CDD MEAL (Suivi, Évaluation, Apprentissage)', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/charge-e-sera_-projet-atinord-securite-h-f/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/charge-e-sera_-projet-atinord-securite-h-f/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('423db2c5535b1bb226d98e45d1b55874edaa13e6165766df6bc02651e1c36040', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/charge-e-sera_-projet-atinord-securite-h-f/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/charge-e-sera_-projet-atinord-securite-h-f/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('95896b8e27a16258b5253a4b416d6df84f56cfea9a623ac91a16d20fcdc60f6c', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Bénin Cashew SA J-3 Bénin Cashew SA recrute 960 postes 📍 Bénin 📋 CDD Management & Coordination', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/benin-cashew-sa-960-postes/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/benin-cashew-sa-960-postes/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('1fd5a80a9d9f91e39e669f31d5efa56a771c41b1b22cafb65079cede27c56437', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/benin-cashew-sa-960-postes/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/benin-cashew-sa-960-postes/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('fbb330119c5a6f6654bedb9e5d24ff0b7384f9ebac5ae5f4a838cbc186270da5', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'HCDH J-8 HCDH recrute 02 postes 📍 Sénégal 📋 CDD Management & Coordination', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/hcdh-recrute-02-postes/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/hcdh-recrute-02-postes/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('d9e7190cd8c07bee454122dd803ec88e90870e02b2cc2fed850be0118e38466e', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/hcdh-recrute-02-postes/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/hcdh-recrute-02-postes/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('907f6d4108ae9269e5dd0c14883f8908f846562ab86ec833b75c0ff8106df77b', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Ambassade de France J-6 Ambassade de France recrute 02 postes 📍 Tchad / Mali 📋 CDD Management & Coordination', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/ambassade-de-france-recrute-02-postes/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/ambassade-de-france-recrute-02-postes/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('0728e0eb5d5553743f6560763ecd85795797417fc497648cfd0f806342052484', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Voir l''offre →', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/emploi/ambassade-de-france-recrute-02-postes/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/emploi/ambassade-de-france-recrute-02-postes/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('a2f4aedfce618b03a7b746bc0571c179efc908d19615c42e2ce6c78e0e741c2f', 'humanitairehub', 'HumanitaireHub', 'https://humanitairehub.com/', 'Alertes emploi', 'HumanitaireHub', 'Burkina Faso', null, null, null, false, 'https://humanitairehub.com/alertes-emploi/', 'A classer', 'needs_review', null, 'https://humanitairehub.com/alertes-emploi/', now(), 0, 0, '2026-06-16T09:29:49.908Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('2abcc1f5b90604f10fecf7d7eb481a07bea79fd482e7729452d36a948e094ade', 'lefaso-recrutement', 'LeFaso.net Recrutement', 'https://emploi.lefaso.net/', '01 Médecin Chirurgien maxillo-facial', 'HOSCO', 'Burkina Faso', '2025-10-27', '2026-06-16', '2025-10-27', false, 'https://emploi.lefaso.net/01-Medecin-Chirurgien-maxillo-facial.html', 'A classer', 'needs_review', '01 Médecin Chirurgien maxillo-facial - Offres d''emploi, de stage et de formation - Emploi, Travail, Job, Carrière Toggle navigation Accueil Offres d''emploi Formations Conseils Entreprises Nos partenaires Contactez-nous Actualité LeFaso.net Conseil du recruteur Générale Vidéos Accueil > Actualité LeFaso.net > 01 Médecin Chirurgien maxillo-facial 01 Médecin Chirurgien maxillo-facial offre deposee 16 juin 2026 par HOSCO Date de clôture de l’offre : 27 octobre 2025 L’Hôpital Saint Camille de Ouagadougou (HOSCO) recrute les profils ci-après : – Médecin Chirurgien maxillo-facial : 01 Date limite de dépôt des dossiers : 27 octobre 2025 Composition du dossier : – Une Demande manuscrite non timbrée adressée au Directeur Général de l’HOSCO ; – Une copie légalisée du diplôme ; – Un CV détaillé ; – Une copie de la CNIB ; – Être inscrit à l’Ordre professionnel ; – Être âgé de 50 ans au plus au 31/12/', 'https://emploi.lefaso.net/01-Medecin-Chirurgien-maxillo-facial.html', '2026-06-16T09:31:23.857Z', 0, 0, '2026-06-16T09:31:18.468Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('d81c08f166e46e37b7c060f846c8fb81d1c8bb67c76b06fb370f50b6fe31d0b6', 'lefaso-recrutement', 'LeFaso.net Recrutement', 'https://emploi.lefaso.net/', '01 Médecin Pneumologue', 'HOSCO', 'Burkina Faso', '2025-10-27', '2026-06-16', '2025-10-27', false, 'https://emploi.lefaso.net/01-Medecin-Pneumologue.html', 'A classer', 'needs_review', '01 Médecin Pneumologue - Offres d''emploi, de stage et de formation - Emploi, Travail, Job, Carrière Toggle navigation Accueil Offres d''emploi Formations Conseils Entreprises Nos partenaires Contactez-nous Actualité LeFaso.net Conseil du recruteur Générale Vidéos Accueil > Actualité LeFaso.net > 01 Médecin Pneumologue 01 Médecin Pneumologue offre deposee 16 juin 2026 par HOSCO Date de clôture de l’offre : 27 octobre 2025 L’Hôpital Saint Camille de Ouagadougou (HOSCO) recrute les profils ci-après : – Médecin Pneumologue : 01 Date limite de dépôt des dossiers : 27 octobre 2025 Composition du dossier : – Une Demande manuscrite non timbrée adressée au Directeur Général de l’HOSCO ; – Une copie légalisée du diplôme ; – Un CV détaillé ; – Une copie de la CNIB ; – Être inscrit à l’Ordre professionnel ; – Être âgé de 50 ans au plus au 31/12/2025. Les dossiers sont recevables au secrétariat de la ', 'https://emploi.lefaso.net/01-Medecin-Pneumologue.html', '2026-06-16T09:31:24.503Z', 0, 0, '2026-06-16T09:31:18.468Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('85fd9c6a77e7aad5ae92d8d90d8b8206767a11f24b50a956a5630c209bd560e9', 'lefaso-recrutement', 'LeFaso.net Recrutement', 'https://emploi.lefaso.net/', '01 Médecin Neurologue', 'Hôpital Saint Camille de Ouagadougou (HOSCO)', 'Burkina Faso', '2025-10-27', '2026-06-16', '2025-10-27', false, 'https://emploi.lefaso.net/01-Medecin-Neurologue.html', 'A classer', 'needs_review', '01 Médecin Neurologue - Offres d''emploi, de stage et de formation - Emploi, Travail, Job, Carrière Toggle navigation Accueil Offres d''emploi Formations Conseils Entreprises Nos partenaires Contactez-nous Actualité LeFaso.net Conseil du recruteur Générale Vidéos Accueil > Actualité LeFaso.net > 01 Médecin Neurologue 01 Médecin Neurologue offre deposee 16 juin 2026 par Hôpital Saint Camille de Ouagadougou (HOSCO) Date de clôture de l’offre : 27 octobre 2025 L’Hôpital Saint Camille de Ouagadougou (HOSCO) recrute les profils ci-après : – Médecin Neurologue : 01 Date limite de dépôt des dossiers : 27 octobre 2025 Composition du dossier : – Une Demande manuscrite non timbrée adressée au Directeur Général de l’HOSCO ; – Une copie légalisée du diplôme ; – Un CV détaillé ; – Une copie de la CNIB ; – Être inscrit à l’Ordre professionnel ; – Être âgé de 50 ans au plus au 31/12/2025. Les dossiers so', 'https://emploi.lefaso.net/01-Medecin-Neurologue.html', '2026-06-16T09:31:26.236Z', 0, 0, '2026-06-16T09:31:18.468Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('593ef96a6c8dba4633b399c130a2c9ec02e0231ecdefe3abdf0dad9e51a573f1', 'lefaso-recrutement', 'LeFaso.net Recrutement', 'https://emploi.lefaso.net/', '01 Pharmacien', 'Une Entreprise de distribution de matériel et équipements', 'Burkina Faso', '2017-08-29', '2026-06-15', '2017-08-29', false, 'https://emploi.lefaso.net/01-Pharmacien.html', 'A classer', 'needs_review', '01 Pharmacien - Offres d''emploi, de stage et de formation - Emploi, Travail, Job, Carrière Toggle navigation Accueil Offres d''emploi Formations Conseils Entreprises Nos partenaires Contactez-nous Actualité LeFaso.net Conseil du recruteur Générale Vidéos Accueil > Actualité LeFaso.net > 01 Pharmacien 01 Pharmacien offre deposee 15 juin 2026 par Une Entreprise de distribution de matériel et équipements Date de clôture de l’offre : 29 août 2017 Capacités liées à l’emploi être inscrit sur le Tableau de l’Ordre des Pharmaciens du Burkina et en règle vis-à-vis de l’Ordre/aptitude à travailler sous pression/autres Connaissance en informatique NP Condition d’âge NP Diplôme ou niveau Doctorat Composition du dossier CV sincère et acutalisé daté et signé/lettre de motivation/photocopie légalisée du diplôme et des attestations de travail/Merci d’envoyer votre candidature à : dos_consultants@yahoo.fr', 'https://emploi.lefaso.net/01-Pharmacien.html', '2026-06-16T09:31:27.853Z', 0, 0, '2026-06-16T09:31:18.468Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('938d2113df7330a264c07438281f1fc339061e96c2c2c98171fa631bb14fe90c', 'lefaso-recrutement', 'LeFaso.net Recrutement', 'https://emploi.lefaso.net/', '02 Chefs de mission ou chefs de projet', 'Cabinet YONS Associates', 'Burkina Faso', '2018-04-30', '2026-06-16', '2018-04-30', false, 'https://emploi.lefaso.net/02-Chefs-de-mission-ou-chefs-de-projet.html', 'A classer', 'needs_review', '02 Chefs de mission ou chefs de projet - Offres d''emploi, de stage et de formation - Emploi, Travail, Job, Carrière Toggle navigation Accueil Offres d''emploi Formations Conseils Entreprises Nos partenaires Contactez-nous Actualité LeFaso.net Conseil du recruteur Générale Vidéos Accueil > Actualité LeFaso.net > 02 Chefs de mission ou chefs de projet 02 Chefs de mission ou chefs de projet offre deposee 16 juin 2026 par Cabinet YONS Associates Date de clôture de l’offre : 30 avril 2018 Le cabinet Yons Associates recrute pour le compte d’une importante société basée à Kossodo les profils suivants : 02 Chefs de mission ou chefs de projet Qualifications, compétences et aptitudes – Etre titulaire d’un diplôme d’Ingénieur Génie Hydraulique, Génie Civil ou Génie Rural, – Justifier d’une expérience professionnelle de cinq (05) ans dans le domaine du BTP, Mission : assurer le pilotage, organisation', 'https://emploi.lefaso.net/02-Chefs-de-mission-ou-chefs-de-projet.html', '2026-06-16T09:31:29.730Z', 0, 0, '2026-06-16T09:31:18.469Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('9074a05022ddb182e61ec7ca93e0d49afc4c1b572313181f86b435407a28cb12', 'lefaso-recrutement', 'LeFaso.net Recrutement', 'https://emploi.lefaso.net/', '02 Ingénieurs chargés d&#8217;affaires/Mines', 'LeFaso.net Recrutement', 'Burkina Faso', null, null, null, false, 'https://emploi.lefaso.net/02-Ingenieurs-charges-d-affaires-Mines.html', 'A classer', 'needs_review', null, 'https://emploi.lefaso.net/02-Ingenieurs-charges-d-affaires-Mines.html', now(), 0, 0, '2026-06-16T09:31:18.469Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('f69dcfb6d18b779ffe1212c219f723a12067babeecf3d16cddb05e8ba3d64f3a', 'lefaso-recrutement', 'LeFaso.net Recrutement', 'https://emploi.lefaso.net/', 'Avis de recrutement d’un(e) Coordonnateur(trice) de Projet', 'LeFaso.net Recrutement', 'Burkina Faso', null, null, null, false, 'https://emploi.lefaso.net/Avis-de-recrutement-d-un-e-Coordonnateur-trice-de-Projet.html', 'A classer', 'needs_review', null, 'https://emploi.lefaso.net/Avis-de-recrutement-d-un-e-Coordonnateur-trice-de-Projet.html', now(), 0, 0, '2026-06-16T09:31:18.469Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (id) do update set
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('bac8b8a935d09327783b4e086125d12822c194e312ba0f2570baa623b514f998', 'lefaso-recrutement', 'LeFaso.net Recrutement', 'https://emploi.lefaso.net/', 'Comment négocier une augmentation ?', 'LeFaso.net Recrutement', 'Burkina Faso', null, null, null, false, 'https://emploi.lefaso.net/Comment-negocier-une-augmentation.html', 'A classer', 'needs_review', null, 'https://emploi.lefaso.net/Comment-negocier-une-augmentation.html', now(), 0, 0, '2026-06-16T09:31:18.469Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('53bcf2a79795e6ff7fd9e9257327f8647632cfb65aaf71e14d360ab80487b913', 'lefaso-recrutement', 'LeFaso.net Recrutement', 'https://emploi.lefaso.net/', '5 règles pour bien gérer son temps', 'LeFaso.net Recrutement', 'Burkina Faso', null, null, null, false, 'https://emploi.lefaso.net/5-regles-pour-bien-gerer-son-temps.html', 'A classer', 'needs_review', null, 'https://emploi.lefaso.net/5-regles-pour-bien-gerer-son-temps.html', now(), 0, 0, '2026-06-16T09:31:18.469Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('6b6e08e25e0295e52becdec508a65984c12fa2c18dc4535d3d20ade0a81a010f', 'lefaso-recrutement', 'LeFaso.net Recrutement', 'https://emploi.lefaso.net/', 'Comment réussir son entretien d&#8217;embauche ?', 'LeFaso.net Recrutement', 'Burkina Faso', null, null, null, false, 'https://emploi.lefaso.net/Comment-reussir-son-entretien-d-embauche.html', 'A classer', 'needs_review', null, 'https://emploi.lefaso.net/Comment-reussir-son-entretien-d-embauche.html', now(), 0, 0, '2026-06-16T09:31:18.469Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('95e2257bc8c36119884a3a847f3d21c790e7ffaa6cba9491850fb0475c25aade', 'burkina24-emploi', 'Burkina24 Emploi', 'https://burkina24.com/', 'CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst)', 'Burkina24 Emploi', 'Burkina Faso', null, null, null, false, 'https://burkina24.com/2026/06/16/cagei-appel-a-candidatures-recrutement-6ieme-promotion-pour-la-formation-certifiante-en-analyse-de-donnees-data-analyst-3/', 'A classer', 'needs_review', '--> >--> >--> window._taboola = window._taboola || []; _taboola.push({article:''auto''}); !function (e, f, u, i) { if (!document.getElementById(i)){ e.async = 1; e.src = u; e.id = i; f.parentNode.insertBefore(e, f); } }(document.createElement(''script''), document.getElementsByTagName(''script'')[0], ''//cdn.taboola.com/libtrc/burkina24/loader.js'', ''tb_loader_script''); if(window.performance && typeof window.performance.mark == ''function'') {window.performance.mark(''tbl_ic'');} CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst) mardi , 16 juin 2026 FLASH INFOS APEC : Sana Sidi Mahamadi et Sawadogo Ousseni élus délégués de la région des Koulsé CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst) Coupe du monde 2026 | ­­France- Sénégal : « Quel que soit ', 'https://burkina24.com/2026/06/16/cagei-appel-a-candidatures-recrutement-6ieme-promotion-pour-la-formation-certifiante-en-analyse-de-donnees-data-analyst-3/', '2026-06-16T09:31:43.662Z', 0, 0, '2026-06-16T09:31:42.643Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  collected_at = excluded.collected_at;
insert into raw_items (id, source_id, source_name, source_url, title, company, city, deadline, opening_date, closing_date, inconsistent_dates, url, category, status, excerpt, canonical_url, detail_extracted_at, risk_score, confidence_score, collected_at)
values ('239fae4c94ed7ba7ab39f22aef7fd34275d142ce134a1f42dfe261a219b6b4b5', 'burkina24-emploi', 'Burkina24 Emploi', 'https://burkina24.com/', 'CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst)', 'Burkina24 Emploi', 'Burkina Faso', null, null, null, false, 'https://burkina24.com/2026/06/16/cagei-appel-a-candidatures-recrutement-6ieme-promotion-pour-la-formation-certifiante-en-analyse-de-donnees-data-analyst-3/', 'A classer', 'needs_review', '--> >--> >--> window._taboola = window._taboola || []; _taboola.push({article:''auto''}); !function (e, f, u, i) { if (!document.getElementById(i)){ e.async = 1; e.src = u; e.id = i; f.parentNode.insertBefore(e, f); } }(document.createElement(''script''), document.getElementsByTagName(''script'')[0], ''//cdn.taboola.com/libtrc/burkina24/loader.js'', ''tb_loader_script''); if(window.performance && typeof window.performance.mark == ''function'') {window.performance.mark(''tbl_ic'');} CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst) mardi , 16 juin 2026 FLASH INFOS APEC : Sana Sidi Mahamadi et Sawadogo Ousseni élus délégués de la région des Koulsé CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst) Coupe du monde 2026 | ­­France- Sénégal : « Quel que soit ', 'https://burkina24.com/2026/06/16/cagei-appel-a-candidatures-recrutement-6ieme-promotion-pour-la-formation-certifiante-en-analyse-de-donnees-data-analyst-3/', '2026-06-16T09:31:44.446Z', 0, 0, '2026-06-16T09:31:42.643Z')
on conflict (id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (raw_item_id) do update set
  ...
  updated_at = now();
insert into jobs (id, raw_item_id, title, company, city, category, job_type, salary, opening_date, closing_date, deadline_label, source_url, canonical_url, summary, tags, confidence_score, risk_score, status, published_at, updated_at)
values ('dfb5594a-751f-4758-8f66-1e00b790b355'::uuid, '95e2257bc8c36119884a3a847f3d21c790e7ffaa6cba9491850fb0475c25aade', 'CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst)', 'Burkina24 Emploi', 'Burkina Faso', 'Bureau', 'A verifier', 'Non communique', '2026-06-16', null, 'A verifier', 'https://burkina24.com/2026/06/16/cagei-appel-a-candidatures-recrutement-6ieme-promotion-pour-la-formation-certifiante-en-analyse-de-donnees-data-analyst-3/', 'https://burkina24.com/2026/06/16/cagei-appel-a-candidatures-recrutement-6ieme-promotion-pour-la-formation-certifiante-en-analyse-de-donnees-data-analyst-3/', '--> >--> >--> window._taboola = window._taboola || []; _taboola.push({article:''auto''}); !function (e, f, u, i) { if (!document.getElementById(i)){ e.async = 1; e.src = u; e.id = i; f.parentNode.insertBefore(e, f); } }(document.createElement(''script''), document.getElementsByTagName(''script'')[0], ''//cdn.taboola.com/libtrc/burkina24/loader.js'', ''tb_loader_script''); if(window.performance && typeof window.performance.mark == ''function'') {window.performance.mark(''tbl_ic'');} CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst) mardi , 16 juin 2026 FLASH INFOS APEC : Sana Sidi Mahamadi et Sawadogo Ousseni élus délégués de la région des Koulsé CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst) Coupe du monde 2026 | ­­France- Sénégal : « Quel que soit', array['Bureau', 'Burkina Faso', 'Burkina24 Emploi']::text[], 70, 0, 'review', '2026-06-16T09:31:42.643Z', now())
on conflict (raw_item_id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  updated_at = now();
insert into jobs (id, raw_item_id, title, company, city, category, job_type, salary, opening_date, closing_date, deadline_label, source_url, canonical_url, summary, tags, confidence_score, risk_score, status, published_at, updated_at)
values ('91aefe66-1c79-4f15-80e4-8721364b84b4'::uuid, '4a1ec186344a99a0fe4622a72b0da387d2849a7d6663710e71ce89b523e804c2', 'Technico Commercial en Climatisation Haut de Gamme- Ouagadougou', 'Emploiburkina', 'Ouagadougou', 'BTP et chantier', 'Mission', 'Non communique', '2026-06-16', null, 'A verifier', 'https://www.emploiburkina.com/offre-emploi-burkina-faso/technico-commercial-climatisation-haut-gamme-ouagadougou-82601', 'https://www.emploiburkina.com/offre-emploi-burkina-faso/technico-commercial-climatisation-haut-gamme-ouagadougou-82601', null, array['BTP et chantier', 'Ouagadougou', 'Emploiburkina', 'climatisation', 'commercial']::text[], 45, 0, 'review', '2026-06-16T09:28:08.032Z', now())
on conflict (raw_item_id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  updated_at = now();
insert into jobs (id, raw_item_id, title, company, city, category, job_type, salary, opening_date, closing_date, deadline_label, source_url, canonical_url, summary, tags, confidence_score, risk_score, status, published_at, updated_at)
values ('177f6d0c-01cb-4773-8dec-dcef34ee3488'::uuid, '0e526ec3ecf8c035ad2ca77961786072c536d6d833cb52dfc448734a6dacd6aa', 'Oxfam International J-13 OORDONNATEUR DE PROGRAMME DU SECTEUR PRIVÉ, 📍 Ghana 📋 CDD Management & Coordination', 'HumanitaireHub', 'Burkina Faso', 'ONG', 'CDD', 'Non communique', '2026-06-16', '2026-06-29', '29 juin 2026', 'https://humanitairehub.com/emploi/oordonnateur-de-programme-du-secteur-prive/', 'https://humanitairehub.com/emploi/oordonnateur-de-programme-du-secteur-prive/', null, array['ONG', 'Burkina Faso', 'HumanitaireHub', 'programme']::text[], 45, 0, 'review', '2026-06-16T09:29:49.908Z', now())
on conflict (raw_item_id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  updated_at = now();
insert into jobs (id, raw_item_id, title, company, city, category, job_type, salary, opening_date, closing_date, deadline_label, source_url, canonical_url, summary, tags, confidence_score, risk_score, status, published_at, updated_at)
values ('8bcc3b88-b82e-4794-8c6a-9dd3705e2109'::uuid, 'f69dcfb6d18b779ffe1212c219f723a12067babeecf3d16cddb05e8ba3d64f3a', 'Avis de recrutement d’un(e) Coordonnateur(trice) de Projet', 'LeFaso.net Recrutement', 'Burkina Faso', 'ONG', 'Mission', 'Non communique', '2026-06-16', null, 'A verifier', 'https://emploi.lefaso.net/Avis-de-recrutement-d-un-e-Coordonnateur-trice-de-Projet.html', 'https://emploi.lefaso.net/Avis-de-recrutement-d-un-e-Coordonnateur-trice-de-Projet.html', null, array['ONG', 'Burkina Faso', 'LeFaso.net Recrutement', 'projet']::text[], 45, 0, 'review', '2026-06-16T09:31:18.469Z', now())
on conflict (raw_item_id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  updated_at = now();
insert into jobs (id, raw_item_id, title, company, city, category, job_type, salary, opening_date, closing_date, deadline_label, source_url, canonical_url, summary, tags, confidence_score, risk_score, status, published_at, updated_at)
values ('6dd49ca0-b7bb-4788-8cb5-281604876f3d'::uuid, '1d3824726dc2ca9a0ad0e95f875e9423cc5ca206b06e712f3e52776fafeb4fb8', 'Communications and Marketing Specialist, Pathfinder Portuguese & English Countries', 'UNjobs Burkina Faso', 'Burkina Faso', 'Commerce et vente', 'CDD', 'Non communique', '2026-06-16', null, 'A verifier', 'https://unjobs.org/vacancies/1779895707052', 'https://unjobs.org/vacancies/1779895707052', null, array['Commerce et vente', 'Burkina Faso', 'UNjobs Burkina Faso', 'marketing']::text[], 45, 0, 'review', '2026-06-16T09:30:22.979Z', now())
on conflict (raw_item_id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (raw_item_id) do update set
  ...
  updated_at = now();
insert into jobs (id, raw_item_id, title, company, city, category, job_type, salary, opening_date, closing_date, deadline_label, source_url, canonical_url, summary, tags, confidence_score, risk_score, status, published_at, updated_at)
values ('14624e58-8a8a-4aff-8510-7ac9ce379d6d'::uuid, '599fc20547fbeefb9012f99ad514616c25e2d84223e0c87f2a526c82e82d45f0', 'CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL)', 'HumanitaireHub', 'Burkina Faso', 'Transport et logistique', 'CDD', 'Non communique', '2026-06-16', '2026-06-23', '23 juin 2026', 'https://humanitairehub.com/emploi/charge-de-securite-et-logistique-national/', 'https://humanitairehub.com/emploi/charge-de-securite-et-logistique-national/', 'CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) ← Retour aux offres WeWorld CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) 📍 Burkina Faso · 📄 CDD ⏰ Deadline 23 Juin 2026 J-7 📧 Postuler par email → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale Logistique Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste 📋 Informations clés Lieu Burkina-Faso Pays Burkina-Faso Date de clôture 23 juin 2026 Organisation WeWorld WeWorld est une organisation laïque et indépendante italienne active depuis 1971 dans la coopération internationale et l’aide humanitaire. I- CONDITIONS DE TRAVAIL ET REMUNERATION', array['Transport et logistique', 'Burkina Faso', 'HumanitaireHub', 'humanitaire', 'logistique']::text[], 70, 0, 'review', '2026-06-16T09:29:49.907Z', now())
on conflict (raw_item_id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (raw_item_id) do update set
  ...
  updated_at = now();
insert into jobs (id, raw_item_id, title, company, city, category, job_type, salary, opening_date, closing_date, deadline_label, source_url, canonical_url, summary, tags, confidence_score, risk_score, status, published_at, updated_at)
values ('4d8bb0a2-2e68-4121-85ed-79e64a35e415'::uuid, '55269b4fca460f79148fbb8c606d39713477605c18ae35263b0fba5a645c0927', 'Executive Secretary- Ouagadougou', 'Emploiburkina', 'Ouagadougou', 'Bureau', 'A verifier', 'Non communique', '2026-06-16', null, 'A verifier', 'https://www.emploiburkina.com/offre-emploi-burkina-faso/executive-secretary-ouagadougou-303736', 'https://www.emploiburkina.com/offre-emploi-burkina-faso/executive-secretary-ouagadougou-303736', null, array['Bureau', 'Ouagadougou', 'Emploiburkina']::text[], 45, 0, 'review', '2026-06-16T09:28:08.032Z', now())
on conflict (raw_item_id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  updated_at = now();
insert into jobs (id, raw_item_id, title, company, city, category, job_type, salary, opening_date, closing_date, deadline_label, source_url, canonical_url, summary, tags, confidence_score, risk_score, status, published_at, updated_at)
values ('df403941-615a-4dce-86b6-a0154e0d2099'::uuid, 'f66f33f4ac4ca14fe3508f1e418104e80f964a9568b318aedf1c1840e8b9af9f', 'Pédiatre Référent (HF)', 'HumanitaireHub', 'Burkina Faso', 'Sante', 'CDD', 'Non communique', '2026-06-16', '2026-06-22', '22 juin 2026', 'https://humanitairehub.com/emploi/pediatre-referent-hf/', 'https://humanitairehub.com/emploi/pediatre-referent-hf/', 'Pédiatre Référent (HF) - Humanitaire Hub Emplois Humanitaires Ressources Mon compte Aller au contenu Emplois Humanitaires Ressources Mon compte Ouvrir/fermer le menu Emplois Humanitaires Connexion Pédiatre Référent (HF) ← Retour aux offres International Rescue Committee (IRC) Pédiatre Référent (HF) 📍 Burkina Faso · 📄 CDD ⏰ Deadline 22 Juin 2026 J-6 📨 Postuler maintenant → 📊 Expérience Confirmé (5-8 ans) 🏢 Type d''org Organisation Internationale Management & Coordination Protection, Genre & Inclusion Santé Partager : 💼 LinkedIn 𝕏 Twitter 📘 Facebook 💬 WhatsApp ✈️ Telegram 📧 Email 🔗 Copier Description du poste 📋 Informations clés Lieu Burkina Faso Pays Burkina Faso Date de clôture 22 juin 2026 Organisation IRC Le Comité international de secours (IRC) intervient lors des crises humanitaires les plus graves au monde, contribuant à rétablir la santé, la sécurité, l’éducation, le bie', array['Sante', 'Burkina Faso', 'HumanitaireHub', 'humanitaire', 'pediatre', 'sante']::text[], 70, 0, 'review', '2026-06-16T09:29:49.907Z', now())
on conflict (raw_item_id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
on conflict (raw_item_id) do update set
  ...
  updated_at = now();
insert into jobs (id, raw_item_id, title, company, city, category, job_type, salary, opening_date, closing_date, deadline_label, source_url, canonical_url, summary, tags, confidence_score, risk_score, status, published_at, updated_at)
values ('6b06210f-2bd2-4b73-8f8a-fdd7322033c0'::uuid, 'dd07b60720e6a48b03e5f25fb941efa31fdc58338bc343c11ad3633f55d780af', 'Magazine Keeper Junior (Magasinier) H/F- Bagassi', 'Emploiburkina', 'Bagassi', 'Transport et logistique', 'CDD', 'Non communique', '2026-06-16', null, 'A verifier', 'https://www.emploiburkina.com/offre-emploi-burkina-faso/magazine-keeper-junior-magasinier-hf-bagassi-303948', 'https://www.emploiburkina.com/offre-emploi-burkina-faso/magazine-keeper-junior-magasinier-hf-bagassi-303948', null, array['Transport et logistique', 'Bagassi', 'Emploiburkina', 'magasinier']::text[], 45, 0, 'review', '2026-06-16T09:28:08.032Z', now())
on conflict (raw_item_id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
  ...
  updated_at = now();
insert into jobs (id, raw_item_id, title, company, city, category, job_type, salary, opening_date, closing_date, deadline_label, source_url, canonical_url, summary, tags, confidence_score, risk_score, status, published_at, updated_at)
values ('6a1e1184-5c24-4c02-8a49-e7692e1d0126'::uuid, 'd32d1c7504c4e82b6c7e70a3cd3d71da43cc0de9e037f5c08d51e8c8b913a388', 'OIBT J-4 Programme de bourses de l&rsquo;OIBT 📍 Pays Membres de l''OIBT 📋 Bourses/Etudes Plusieurs Secteurs', 'HumanitaireHub', 'Burkina Faso', 'ONG', 'Mission', 'Non communique', '2026-06-16', '2026-06-20', '20 juin 2026', 'https://humanitairehub.com/emploi/programme-de-bourses-de-loibt/', 'https://humanitairehub.com/emploi/programme-de-bourses-de-loibt/', null, array['ONG', 'Burkina Faso', 'HumanitaireHub', 'programme']::text[], 45, 0, 'review', '2026-06-16T09:29:49.908Z', now())
on conflict (raw_item_id) do update set
  title = excluded.title,
  company = excluded.company,
  city = excluded.city,
...
values ('index.html', 'JobFaso - Emploi, recrutement, concours et stages au Burkina Faso', 'JobFaso centralise les offres d', 'home', 'https://jobfaso.com/index.html', '2026-06-16', 'weekly', 1, true, now())
on conflict (path) do update set
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('jobs.html', 'Offres d''emploi au Burkina Faso - JobFaso', 'Toutes les offres d', 'jobs', 'https://jobfaso.com/jobs.html', '2026-06-16', 'weekly', 0.9, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('conseils.html', 'Conseils emploi Burkina Faso - CV, entretien, concours | JobFaso', 'Guides pratiques pour CV, lettres, entretiens, concours, ONG et candidatures professionnelles au Burkina Faso.', 'page', 'https://jobfaso.com/conseils.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('grille-tarifaire.html', 'Tarifs recruteurs et publicite emploi - JobFaso', 'Packs annonces, offres sponsorisees, diffusion WhatsApp, publicite native et solutions recruteurs sur JobFaso.', 'page', 'https://jobfaso.com/grille-tarifaire.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('annonceurs.html', 'Publier une offre d''emploi au Burkina Faso - JobFaso', 'Publiez une annonce, sponsorisez une offre, recevez des leads candidats et touchez une audience emploi au Burkina Faso.', 'page', 'https://jobfaso.com/annonceurs.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('contacts.html', 'Contact JobFaso - Publier, signaler ou proposer une source', 'Contactez JobFaso pour publier une offre, signaler une annonce, proposer une source emploi ou devenir partenaire.', 'page', 'https://jobfaso.com/contacts.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('contact.html', 'Contact JobFaso - Recruteurs, candidats et partenaires', 'Formulaire de contact JobFaso pour candidats, recruteurs, sources emploi et partenaires au Burkina Faso.', 'page', 'https://jobfaso.com/contact.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('privacy.html', 'Confidentialite - JobFaso', 'Politique de confidentialite JobFaso pour candidats, recruteurs et visiteurs.', 'page', 'https://jobfaso.com/privacy.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('terms.html', 'Mentions legales et conditions - JobFaso', 'Conditions d', 'page', 'https://jobfaso.com/terms.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
...
on conflict (path) do update set
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/cagei-appel-a-candidatures-recrutement-6ieme-promotion-pour-la-formation-certifiante-en-an-95e2257b.html', 'CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst) - Burkina Faso | JobFaso', 'CAGEI | Appel à candidatures : Recrutement 6ième promotion pour la formation certifiante en Analyse de données (Data Analyst) chez Burkina24 Emploi au Burkina Faso. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/cagei-appel-a-candidatures-recrutement-6ieme-promotion-pour-la-formation-certifiante-en-an-95e2257b.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/technico-commercial-en-climatisation-haut-de-gamme-ouagadougou-4a1ec186.html', 'Technico Commercial en Climatisation Haut de Gamme- Ouagadougou - Ouagadougou | JobFaso', 'Technico Commercial en Climatisation Haut de Gamme- Ouagadougou chez Emploiburkina au Ouagadougou. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/technico-commercial-en-climatisation-haut-de-gamme-ouagadougou-4a1ec186.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/oxfam-international-j-13-oordonnateur-de-programme-du-secteur-prive-ghana-cdd-management-e-0e526ec3.html', 'Oxfam International J-13 OORDONNATEUR DE PROGRAMME DU SECTEUR PRIVÉ, 📍 Ghana 📋 CDD Management &amp; Coordination - Burkina Faso | JobFaso', 'Oxfam International J-13 OORDONNATEUR DE PROGRAMME DU SECTEUR PRIVÉ, 📍 Ghana 📋 CDD Management &amp; Coordination chez HumanitaireHub au Burkina Faso. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/oxfam-international-j-13-oordonnateur-de-programme-du-secteur-prive-ghana-cdd-management-e-0e526ec3.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
...
on conflict (path) do update set
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/responsable-de-recherche-5114bd32.html', 'Responsable de Recherche - Ouagadougou | JobFaso', 'Responsable de Recherche chez BFemploi au Ouagadougou. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/responsable-de-recherche-5114bd32.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/secretaire-comptable-ouagadougou-ea6a30c7.html', 'Sécretaire Comptable- Ouagadougou - Ouagadougou | JobFaso', 'Sécretaire Comptable- Ouagadougou chez Emploiburkina au Ouagadougou. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/secretaire-comptable-ouagadougou-ea6a30c7.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/charge-de-securite-et-logistique-national-599fc205.html', 'CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) - Burkina Faso | JobFaso', 'CHARGE DE SECURITE ET LOGISTIQUE – (NATIONAL) chez HumanitaireHub au Burkina Faso. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/charge-de-securite-et-logistique-national-599fc205.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/enqueteurs-chercheurs-de-terrain-ac8e8a25.html', 'Enquêteurs / Chercheurs de terrain - Burkina Faso | JobFaso', 'Enquêteurs / Chercheurs de terrain chez BFemploi au Burkina Faso. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/enqueteurs-chercheurs-de-terrain-ac8e8a25.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/executive-secretary-ouagadougou-55269b4f.html', 'Executive Secretary- Ouagadougou - Ouagadougou | JobFaso', 'Executive Secretary- Ouagadougou chez Emploiburkina au Ouagadougou. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/executive-secretary-ouagadougou-55269b4f.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/pediatre-referent-hf-f66f33f4.html', 'Pédiatre Référent (HF) - Burkina Faso | JobFaso', 'Pédiatre Référent (HF) chez HumanitaireHub au Burkina Faso. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/pediatre-referent-hf-f66f33f4.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/responsable-relations-bailleurs-h-f-tout-pays-085b3a6f.html', 'Responsable Relations Bailleurs H/F Tout Pays - Burkina Faso | JobFaso', 'Responsable Relations Bailleurs H/F Tout Pays chez BFemploi au Burkina Faso. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/responsable-relations-bailleurs-h-f-tout-pays-085b3a6f.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/magazine-keeper-junior-magasinier-h-f-bagassi-dd07b607.html', 'Magazine Keeper Junior (Magasinier) H/F- Bagassi - Bagassi | JobFaso', 'Magazine Keeper Junior (Magasinier) H/F- Bagassi chez Emploiburkina au Bagassi. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/magazine-keeper-junior-magasinier-h-f-bagassi-dd07b607.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/oibt-j-4-programme-de-bourses-de-l-et-rsquo-oibt-pays-membres-de-l-oibt-bourses-etudes-plu-d32d1c75.html', 'OIBT J-4 Programme de bourses de l&amp;rsquo;OIBT 📍 Pays Membres de l&#039;OIBT 📋 Bourses/Etudes Plusieurs Secteurs - Burkina Faso | JobFaso', 'OIBT J-4 Programme de bourses de l&amp;rsquo;OIBT 📍 Pays Membres de l&#039;OIBT 📋 Bourses/Etudes Plusieurs Secteurs chez HumanitaireHub au Burkina Faso. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/oibt-j-4-programme-de-bourses-de-l-et-rsquo-oibt-pays-membres-de-l-oibt-bourses-etudes-plu-d32d1c75.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
...
on conflict (path) do update set
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/cash-academy-program-coordinator-b511815e.html', 'Cash Academy Program Coordinator - Burkina Faso | JobFaso', 'Cash Academy Program Coordinator chez BFemploi au Burkina Faso. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/cash-academy-program-coordinator-b511815e.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/secretaire-ouagadougou-562f6780.html', 'Secrétaire- Ouagadougou - Ouagadougou | JobFaso', 'Secrétaire- Ouagadougou chez Emploiburkina au Ouagadougou. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/secretaire-ouagadougou-562f6780.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/programme-officer-school-meals-dd10c613.html', 'Programme Officer - School Meals - Burkina Faso | JobFaso', 'Programme Officer - School Meals chez BFemploi au Burkina Faso. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/programme-officer-school-meals-dd10c613.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/jobs/angular-developer-m-f-db86e6a3.html', 'ANGULAR Developer (M/F) - Burkina Faso | JobFaso', 'ANGULAR Developer (M/F) chez Emploiburkina au Burkina Faso. Consultez la source officielle et recevez les alertes JobFaso.', 'job', 'https://jobfaso.com/pages/jobs/angular-developer-m-f-db86e6a3.html', '2026-06-16', 'daily', 0.8, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
...
on conflict (path) do update set
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/categories/sante.html', 'Emplois sante au Burkina Faso | JobFaso', 'Offres medicales, paramedicales, pharmacie, clinique, projets sante et missions de terrain. Alertes WhatsApp, sources verifiees et opportunites recentes.', 'category', 'https://jobfaso.com/pages/categories/sante.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
...
on conflict (path) do update set
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/villes/bagassi.html', 'Emploi Bagassi | JobFaso', 'Offres d&#039;emploi, concours, stages et missions a Bagassi. Recevez les alertes JobFaso sur WhatsApp.', 'city', 'https://jobfaso.com/pages/villes/bagassi.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/villes/burkina-faso.html', 'Emploi Burkina Faso | JobFaso', 'Offres d&#039;emploi, concours, stages et missions a Burkina Faso. Recevez les alertes JobFaso sur WhatsApp.', 'city', 'https://jobfaso.com/pages/villes/burkina-faso.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/villes/ouagadougou.html', 'Emploi Ouagadougou | JobFaso', 'Offres d&#039;emploi, concours, stages et missions a Ouagadougou. Recevez les alertes JobFaso sur WhatsApp.', 'city', 'https://jobfaso.com/pages/villes/ouagadougou.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/guides/faire-un-cv-au-burkina-faso.html', 'Comment faire un bon CV au Burkina Faso | JobFaso', 'Structure simple pour creer un CV clair, lisible et adapte aux recruteurs au Burkina Faso.', 'guide', 'https://jobfaso.com/pages/guides/faire-un-cv-au-burkina-faso.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/guides/eviter-fausses-offres-emploi.html', 'Comment eviter les fausses offres d&#039;emploi | JobFaso', 'Signaux d&#039;alerte, verification des sources et bons reflexes avant de candidater.', 'guide', 'https://jobfaso.com/pages/guides/eviter-fausses-offres-emploi.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/guides/postuler-ong-burkina.html', 'Comment postuler a une ONG au Burkina Faso | JobFaso', 'Conseils pour candidater aux ONG, projets internationaux et organisations humanitaires.', 'guide', 'https://jobfaso.com/pages/guides/postuler-ong-burkina.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/guides/preparer-un-concours.html', 'Comment preparer un concours au Burkina Faso | JobFaso', 'Organisation, documents, revision et suivi des communiques officiels.', 'guide', 'https://jobfaso.com/pages/guides/preparer-un-concours.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/guides/rediger-une-lettre-de-motivation.html', 'Rediger une lettre de motivation efficace | JobFaso', 'Methode simple pour ecrire une lettre claire, courte et adaptee a l&#039;offre visee.', 'guide', 'https://jobfaso.com/pages/guides/rediger-une-lettre-de-motivation.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/guides/preparer-un-entretien-emploi.html', 'Preparer un entretien d&#039;embauche | JobFaso', 'Questions frequentes, attitude professionnelle et documents a preparer avant un entretien.', 'guide', 'https://jobfaso.com/pages/guides/preparer-un-entretien-emploi.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
  ...
  updated_at = now();
insert into seo_pages (path, title, description, page_type, canonical_url, lastmod, changefreq, priority, is_indexable, updated_at)
values ('pages/guides/documents-pour-postuler.html', 'Documents a preparer pour postuler | JobFaso', 'Liste pratique des documents souvent demandes pour emplois, stages, ONG et concours.', 'guide', 'https://jobfaso.com/pages/guides/documents-pour-postuler.html', '2026-06-16', 'weekly', 0.7, true, now())
on conflict (path) do update set
  title = excluded.title,
  description = excluded.description,
  page_type = excluded.page_type,
