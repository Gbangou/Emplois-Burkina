...
- Ne pas renommer brutalement Emplois Burkina maintenant : Garder Emplois Burkina comme verticale locale et ajouter une section international/remote.
- Creer une marque mere plus large seulement quand la section internationale prouve son trafic : Prevoir une architecture type Emplois Burkina + Jobs Afrique + Remote Afrique.
- Scraper moins, enrichir plus : Publier resumes courts, liens officiels, filtres, scoring, guides, tendances et pages originales.
- Privilegier RSS, API, pages officielles et sources qui autorisent la reprise : Classer chaque source en official_link, rss_api, review_required ou manual_only.
